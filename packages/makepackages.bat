...
del "Release Notes v.1.7.1.txt"
xcopy /f /y "..\Release Notes\Release Notes v1.7.1.md"
ren "Release Notes v1.7.1.md" "Release Notes v1.7.1.txt"

set ZIPEXE="C:\Program Files\7-Zip\7z.exe"
set ZIPFILE=%PACKAGES%\CSharpDriver-%VER%.zip
%ZIPEXE% a %ZIPFILE% ..\License.txt
%ZIPEXE% a %ZIPFILE% "Release Notes v1.7.1.txt"
