...
namespace MongoDB.BsonUnitTests.DefaultSerializer {
    ...
    public class DiscriminatorTests {
        ...
        public void TestSerializeFAsF() {
            ...
            var bson = f.ToBson<F>();
            var rehydrated = BsonSerializer.DeserializeDocument<F>(bson);
        ...
        public void TestSerializeGAsG() {
            ...
            var bson = g.ToBson<G>();
            var rehydrated = BsonSerializer.DeserializeDocument<G>(bson);
        ...
        public void TestSerializeHAsH() {
            ...
            var bson = h.ToBson<H>();
            var rehydrated = BsonSerializer.DeserializeDocument<H>(bson);
