...
namespace MongoDB.Driver.GeoJsonObjectModel.Serializers
{
    ...
    /// </summary>
    public class GeoJsonMultiPointCoordinatesSerializer<TCoordinates> : BsonBaseSerializer where TCoordinates : GeoJsonCoordinates
    {
        // private fields
        ...
        public override void Serialize(BsonWriter bsonWriter, Type nominalType, object value, IBsonSerializationOptions options)
        {
            ...
            {
                var lineStringCoordinates = (GeoJsonMultiPointCoordinates<TCoordinates>)value;
