...
{
    [TestFixture]
    public class When_replacing_a_document_that_does_exist_and_returning_the_original : CollectionUsingSpecification
    {
        ...
        [Test]
        public void Result_should_be_the_original_document()
        {
