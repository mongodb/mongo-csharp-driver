...
{
    [TestFixture]
    public class When_finding_a_subset_of_documents : CollectionUsingSpecification
    {
        ...
        protected override void Given()
        {
            ...
            {
                Criteria = BsonDocument.Parse("{x: {$gt: 1}}"),
                Skip = 2
            };
        ...
        [Test]
        public void Result_should_include_matching_documents()
        {
