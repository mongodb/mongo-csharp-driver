...
{
    [TestFixture]
    public class When_second_batch_has_an_error_and_isOrdered_is_true : CollectionUsingSpecification
    {
        ...
        public void Result_should_have_the_expected_values()
        {
            ...
            result.ProcessedRequests.Should().Equal(_requests.Take(4), SameAs.Predicate);
        ...
        {
            _exception.UnprocessedRequests.Should().Equal(_requests.Skip(4), SameAs.Predicate);
        }
        ...
        public void Collection_should_contain_the_expected_documents()
        {
            ...
            documents.Should().Equal(_documents.Take(3));
        }
    }
}
