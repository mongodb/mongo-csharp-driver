...
{
    [TestFixture]
    public class When_there_are_multiple_deletes : CollectionUsingSpecification
    {
        ...
        protected override void Given()
        {
            ...
            Insert(initialDocuments);

            _requests = new[]
            {
                new DeleteRequest(new BsonDocument("_id", 1)),
        ...
        public void Result_should_have_the_expected_values()
        {
            ...
            _result.RequestCount.Should().Be(2);
