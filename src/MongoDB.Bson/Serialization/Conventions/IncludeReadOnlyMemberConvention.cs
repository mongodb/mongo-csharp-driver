...
namespace MongoDB.Bson.Serialization.Conventions
{
    ...
    */
    ...
    /// <summary>
    /// A convention that includes readable members and adds them to the class map.
    /// </summary>
    public class IncludeReadOnlyMemberConvention : ConventionBase, IClassMapConvention
    {
        // private fields
        ...
        // constructors
        /// <summary>
        /// Initializes a new instance of the <see cref="IncludeReadOnlyMemberConvention" /> class.
        /// </summary>
        public IncludeReadOnlyMemberConvention()
        ...
        public IncludeReadOnlyMemberConvention(MemberTypes memberTypes)
        ...
        public IncludeReadOnlyMemberConvention(BindingFlags bindingFlags)
        ...
        /// <param name="memberTypes">The member types.</param>
        /// <param name="bindingFlags">The binding flags.</param>
        public IncludeReadOnlyMemberConvention(MemberTypes memberTypes, BindingFlags bindingFlags)
        {
