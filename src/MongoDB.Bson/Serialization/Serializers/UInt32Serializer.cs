...
namespace MongoDB.Bson.Serialization.Serializers
{
    ...
    /// </summary>
    [CLSCompliant(false)]
    public sealed class UInt32Serializer : StructSerializerBase<uint>, IRepresentationConfigurable<UInt32Serializer>, IRepresentationConverterConfigurable<UInt32Serializer>
    {
        // private fields
        ...
        public UInt32Serializer(BsonType representation, RepresentationConverter converter)
        {
            switch (representation)
            {
                ...
                default:
                    var message = string.Format("{0} is not a valid representation for a UInt32Serializer.", representation);
        ...
        public override uint Deserialize(BsonDeserializationContext context, BsonDeserializationArgs args)
        {
            ...
            {
                case BsonType.Decimal128:
                    return _converter.ToUInt32(bsonReader.ReadDecimal128());
                ...
                case BsonType.String:
                    return JsonConvert.ToUInt32(bsonReader.ReadString());
