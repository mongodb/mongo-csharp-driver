...
{
    /// <summary>
    /// Represents a serializer for ImmutableSortedSets.
    /// </summary>
    ...
    public class ImmutableSortedSetSerializer<T>: EnumerableInterfaceImplementerSerializerBase<ImmutableSortedSet<T>, T>
    {
        ...
        /// <inheritdoc/>
        protected override ImmutableSortedSet<T> FinalizeResult(object accumulator)
        {
            return ((ImmutableSortedSet<T>.Builder)accumulator).ToImmutable();
        }
    }
}
#endif