...
namespace MongoDB.Bson.Serialization.Serializers
{
    ...
    /// </summary>
    [CLSCompliant(false)]
    public class UInt16Serializer : StructSerializerBase<ushort>,
        IBsonNumericSerializer,
        IRepresentationConfigurable<UInt16Serializer>,
        IRepresentationConverterConfigurable<UInt16Serializer>
    {
        // private fields
        ...
        public override ushort Deserialize(BsonDeserializationContext context, BsonDeserializationArgs args)
        {
            ...
            {
                case BsonType.Decimal128:
                    return _converter.ToUInt16(bsonReader.ReadDecimal128());
                ...
                case BsonType.String:
                    return JsonConvert.ToUInt16(bsonReader.ReadString());
