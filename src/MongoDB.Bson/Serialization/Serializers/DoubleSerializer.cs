...
namespace MongoDB.Bson.Serialization.Serializers
{
    ...
    /// </summary>
    public sealed class DoubleSerializer : StructSerializerBase<double>, IRepresentationConfigurable<DoubleSerializer>, IRepresentationConverterConfigurable<DoubleSerializer>
    {
        #region static
