...
namespace MongoDB.Bson.Serialization.Serializers
{
    ...
    public class BsonUndefinedSerializer : BsonValueSerializerBase<BsonUndefined>
    {
        ...
        protected override BsonUndefined DeserializeValue(BsonDeserializationContext context, BsonDeserializationArgs args)
        {
        ...
        protected override void SerializeValue(BsonSerializationContext context, BsonSerializationArgs args, BsonUndefined value)
        {
