...
{
    [TestFixture]
    public class When_running_a_command_with_a_custom_class : SpecificationBase
    {
        ...
        private class IsMasterCommand
        {
            [BsonElement("ismaster")]
            public readonly int IsMaster = 1;
        }
    }
}