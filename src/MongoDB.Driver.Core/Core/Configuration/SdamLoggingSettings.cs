...
namespace MongoDB.Driver.Core.Configuration
{
    ...
    {   
        ...
        /// "stdout" sebns output to stdout. </param>
        ...
        /// </summary>
        internal bool LoggingEnabled => !string.IsNullOrEmpty(_logFilename);

        /// <summary>
        /// Whether or not logging should be written stdout.
        /// </summary>
        internal bool LogToStdout => _logFilename == "stdout";
    }
}