...
namespace MongoDB.Driver.Core.Misc
{
    ...
    public class Feature
    {
        ...
        private static readonly Feature __aggregateOutOnSecondaryTimeSeries = new Feature("AggregateOutOnSecondaryTimeSeries", WireVersion.Server70);
        ...
        /// <summary>
        /// Gets the aggregate out to time series collection feature.
        /// </summary>
        ...
        /// <summary>
        /// Gets the aggregate out to time series collection on secondary feature.
        /// </summary>
        public static Feature AggregateOutOnSecondaryTimeSeries => __aggregateOutOnSecondaryTimeSeries;
