...
namespace MongoDB.Driver.Core.Clusters
{
    ...
    internal abstract class Cluster : ICluster
    {
        ...
        private static readonly SemanticVersion __minSupportedServerVersion = WireVersion.FirstSupportedServerVersion;
        private static readonly IServerSelector __randomServerSelector = new RandomServerSelector();
        private static readonly Range<int> __supportedWireVersionRange = WireVersion.SupportedWireRange;
