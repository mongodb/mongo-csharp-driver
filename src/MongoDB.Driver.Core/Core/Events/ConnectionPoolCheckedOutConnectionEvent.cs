...
namespace MongoDB.Driver.Core.Events
{
    ...
    public struct ConnectionPoolCheckedOutConnectionEvent
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ConnectionPoolCheckedOutConnectionEvent"/> struct.
        /// </summary>
        /// <param name="connectionId">The connection identifier.</param>
        /// <param name="duration">The duration of time it took to check out the connection.</param>
        public ConnectionPoolCheckedOutConnectionEvent(ConnectionId connectionId, TimeSpan duration)
        {
