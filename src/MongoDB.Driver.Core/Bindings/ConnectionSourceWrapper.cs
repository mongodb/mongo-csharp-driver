...
{
    public abstract class ConnectionSourceWrapper : IConnectionSource
    {
        // fields
        private bool _disposed;
        private readonly bool _ownsWrapped;
        private readonly IConnectionSource _wrapped;

        // constructors
        protected ConnectionSourceWrapper(IConnectionSource wrapped, bool ownsWrapped = true)
        {
        ...
        public virtual ServerDescription ServerDescription
        {
            get { return _wrapped.ServerDescription; }
        }
        ...
        public virtual IConnectionSource Fork()
        {
