...
{
    public abstract class ReadWriteBindingWrapper : ReadBindingWrapper, IReadWriteBinding
    {
        // fields
        private readonly IReadWriteBinding _wrapped;

        // constructors
        public ReadWriteBindingWrapper(IReadWriteBinding wrapped, bool ownsWrapped = true)
