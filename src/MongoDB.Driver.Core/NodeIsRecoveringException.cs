...
namespace MongoDB.Driver
{
    ...
    public class NodeIsRecoveringException : MongoException
    {
        ...
        // constructors
        public NodeIsRecoveringException(BsonDocument result)
            : base("Server returned node is recovering error.")
        {
            _result = Ensure.IsNotNull(result, "result");
        }

        protected NodeIsRecoveringException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
