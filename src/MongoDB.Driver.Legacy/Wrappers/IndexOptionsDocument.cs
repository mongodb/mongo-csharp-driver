...
namespace MongoDB.Driver
{
    ...
    public class IndexOptionsDocument : BsonDocument, IMongoIndexOptions
    {
        // constructors
        /// <summary>
        ...
        // nested classes
        internal class Serializer : SerializeAsNominalTypeSerializer<IndexOptionsDocument, BsonDocument>
        {
        }
    }
}
