...
{
    public class ExtraElementsWithPartiallyImmutableClassUsingBsonDocumentTests
    {
        private class C
        {
    ...
    public class ExtraElementsWithPartiallyImmutableClassUsingDictionaryTests
    {
        private class C
        {
            private readonly int _id;
