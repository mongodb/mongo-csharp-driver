...
namespace MongoDB.Driver.Core.Operations
{
    internal sealed class GroupOperation<TResult> : IReadOperation<IEnumerable<TResult>>
    {
        ...
        private ReadCommandOperation<TResult[]> CreateOperation()
        {
            ...
            var resultSerializer = _resultSerializer ?? _messageEncoderSettings.GetOrDefault(MessageEncoderSettingsName.SerializationDomain, BsonSerializer.DefaultSerializationDomain).LookupSerializer<TResult>();
