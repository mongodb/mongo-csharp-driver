        ...
        public override void Initialize()
        {
            ...
            if (_state.TryChange(State.Initial, State.Open))
            {
                ...
                if (Settings.Scheme == ConnectionStringScheme.MongoDBPlusSrv)
                {
                    ...
                    var dnsMonitor = _dnsMonitorFactory.CreateDnsMonitor(this, Settings.SrvServiceName, lookupDomainName, Settings.SrvAllowedHostsSuffix, _monitorServersCancellationTokenSource.Token);
