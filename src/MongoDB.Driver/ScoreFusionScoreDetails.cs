...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ScoreFusionScoreDetails"/> class.
    /// </summary>
    ...
    /// <param name="normalization">The normalization applied to per-pipeline scores before combination (e.g. "none", "sigmoid", "minMaxScaler").</param>
    /// <param name="combination">The combination configuration used to merge per-pipeline scores.</param>
    /// <param name="details">Info about how each input pipeline in the scoreFusion stage contributed to the computed score.</param>
    /// <seealso cref="IAggregateFluentExtensions.ScoreFusion{TResult, TNewResult}(IAggregateFluent{TResult}, Dictionary{string,PipelineDefinition{TResult,TNewResult}}, ScoreFusionNormalization, Dictionary{string,double}, ScoreFusionOptions{TNewResult})"/>
