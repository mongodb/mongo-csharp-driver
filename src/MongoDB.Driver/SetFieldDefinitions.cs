...
namespace MongoDB.Driver
{
    ...
    public sealed class ListSetFieldDefinitions<TDocument> : SetFieldDefinitions<TDocument>
    {
        ...
        public override BsonDocument Render(RenderArgs<TDocument> renderArgs)
        {
            ...
            {
                var renderedSetFieldDefinition = setFieldDefinition.Render(renderArgs);
    ...
    public sealed class ExpressionSetFieldDefinitions<TDocument, TFields> : SetFieldDefinitions<TDocument>
    {
        ...
        public override BsonDocument Render(RenderArgs<TDocument> renderArgs)
        {
            ...
            var stage = linqAdapter.TranslateExpressionToSetStage(_expression, renderArgs.DocumentSerializer, renderArgs.SerializerRegistry);
