...
{
    internal sealed class UnionExpression : ExtensionExpression, ISourcedExpression
    {
        ...
        {
            get { return ExtensionExpressionType.Union; }
        }
        ...
        public UnionExpression Update(Expression source, Expression other)
        {
            if (source != _source ||
                other != _other)
            {
                return new UnionExpression(source, other);
            }
