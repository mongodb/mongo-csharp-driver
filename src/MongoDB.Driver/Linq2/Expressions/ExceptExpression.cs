...
{
    internal sealed class ExceptExpression : ExtensionExpression, ISourcedExpression
    {
        ...
        {
            get { return ExtensionExpressionType.Except; }
        }
        ...
        public ExceptExpression Update(Expression source, Expression other)
        {
            if (source != _source ||
                other != _other)
            {
                return new ExceptExpression(source, other);
            }
