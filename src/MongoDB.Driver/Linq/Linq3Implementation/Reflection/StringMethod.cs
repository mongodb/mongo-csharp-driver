...
namespace MongoDB.Driver.Linq.Linq3Implementation.Misc
{
    internal static class StringMethod
    {
        ...
        private static readonly MethodInfo __compareWithIgnoreCaseAndCulture;
        private static readonly MethodInfo __compareWithCultureAndOptions;
        private static readonly MethodInfo __compareWithComparisonType;
        private static readonly MethodInfo __compareWithIndexesAndLength;
        private static readonly MethodInfo __compareWithIndexesAndLengthAndIgnoreCase;
        private static readonly MethodInfo __compareWithIndexesAndLengthAndIgnoreCaseAndCulture;
        private static readonly MethodInfo __compareWithIndexesAndLengthAndCultureAndOptions;
        private static readonly MethodInfo __compareWithIndexesAndLengthAndComparisonType;
        ...
        static StringMethod()
        {
            ...
            __compare = ReflectionInfo.Method((string a, string b) => string.Compare(a, b));
            __compareWithIgnoreCase = ReflectionInfo.Method((string a, string b, bool ignoreCase) => string.Compare(a, b, ignoreCase));
            __compareWithIgnoreCaseAndCulture = ReflectionInfo.Method((string a, string b, bool ignoreCase, CultureInfo culture) => string.Compare(a, b, ignoreCase, culture));
            __compareWithCultureAndOptions = ReflectionInfo.Method((string a, string b, CultureInfo culture, CompareOptions options) => string.Compare(a, b, culture, options));
            __compareWithComparisonType = ReflectionInfo.Method((string a, string b, StringComparison comparisonType) => string.Compare(a, b, comparisonType));
            __compareWithIndexesAndLength = ReflectionInfo.Method((string a, int indexA, string b, int indexB, int length) => string.Compare(a, indexA, b, indexB, length));
            __compareWithIndexesAndLengthAndIgnoreCase = ReflectionInfo.Method((string a, int indexA, string b, int indexB, int length, bool ignoreCase) => string.Compare(a, indexA, b, indexB, length, ignoreCase));
            __compareWithIndexesAndLengthAndIgnoreCaseAndCulture = ReflectionInfo.Method((string a, int indexA, string b, int indexB, int length, bool ignoreCase, CultureInfo culture) => string.Compare(a, indexA, b, indexB, length, ignoreCase, culture));
            __compareWithIndexesAndLengthAndCultureAndOptions = ReflectionInfo.Method((string a, int indexA, string b, int indexB, int length, CultureInfo culture, CompareOptions options) => string.Compare(a, indexA, b, indexB, length, culture, options));
            __compareWithIndexesAndLengthAndComparisonType = ReflectionInfo.Method((string a, int indexA, string b, int indexB, int length, StringComparison comparisonType) => string.Compare(a, indexA, b, indexB, length, comparisonType));
        ...
        public static MethodInfo CompareWithIgnoreCaseAndCulture => __compareWithIgnoreCaseAndCulture;
        public static MethodInfo CompareWithCultureAndOptions => __compareWithCultureAndOptions;
        public static MethodInfo CompareWithComparisonType => __compareWithComparisonType;
        public static MethodInfo CompareWithIndexesAndLength => __compareWithIndexesAndLength;
        public static MethodInfo CompareWithIndexesAndLengthAndIgnoreCase => __compareWithIndexesAndLengthAndIgnoreCase;
        public static MethodInfo CompareWithIndexesAndLengthAndIgnoreCaseAndCulture => __compareWithIndexesAndLengthAndIgnoreCaseAndCulture;
        public static MethodInfo CompareWithIndexesAndLengthAndCultureAndOptions => __compareWithIndexesAndLengthAndCultureAndOptions;
        public static MethodInfo CompareWithIndexesAndLengthAndComparisonType => __compareWithIndexesAndLengthAndComparisonType;
