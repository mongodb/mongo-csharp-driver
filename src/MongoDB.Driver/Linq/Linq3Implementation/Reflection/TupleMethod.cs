...
{
    internal static class TupleMethod
    {
        ...
        static TupleMethod()
        {
            ...
            __create4 = ReflectionInfo.Method((object item1, object item2, object item3, object item4) => Tuple.Create(item1, item2, item3, item4));
            __create5 = ReflectionInfo.Method((object item1, object item2, object item3, object item4, object item5) => Tuple.Create(item1, item2, item3, item4, item5));
