...
namespace MongoDB.Driver.Linq.Linq3Implementation.Translators.ExpressionToAggregationExpressionTranslators
{
    internal static class MemberInitExpressionToAggregationExpressionTranslator
    {
        ...
        {
            return
                context.KnownSerializers.IsKnown(expression, out var knownSerializer) ?
                    MemberInitExpressionWithKnownSerializerToAggregationExpressionTranslator.TranslateWithKnownSerializer(context, expression, newExpression, bindings, knownSerializer) :
                    MemberInitExpressionWithoutKnownSerializerToAggregationExpressionTranslator.TranslateWithoutKnownSerializer(context, expression, newExpression, bindings);
        }
    }
}
