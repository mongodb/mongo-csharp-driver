    ...
    internal static class MethodCallExpressionToAggregationExpressionTranslator
    {
        public static TranslatedExpression Translate(TranslationContext context, MethodCallExpression expression)
        {
            switch (expression.Method.Name)
            {
                ...
                case "Replace": return ReplaceMethodToAggregationExpressionTranslator.Translate(context, expression);
                ...
                case "TakeLast":
                    return TakeLastMethodToAggregationExpressionTranslator.Translate(context, expression);
