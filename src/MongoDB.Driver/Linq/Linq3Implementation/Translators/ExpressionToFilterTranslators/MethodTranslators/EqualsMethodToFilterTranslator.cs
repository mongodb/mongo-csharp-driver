...
{
    internal static class EqualsMethodToFilterTranslator
    {
        ...
        private static AstFilter Translate(TranslationContext context, Expression expression, Expression expression1, Expression expression2)
        {
            ...
            {
                valueSerializer = FieldValueSerializerHelper.GetSerializerForValueType(fieldTranslation.Serializer, context.SerializationDomain.SerializerRegistry, valueType);
            }
            else
            {
