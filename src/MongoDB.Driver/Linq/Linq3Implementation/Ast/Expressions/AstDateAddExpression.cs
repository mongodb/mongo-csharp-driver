...
{
    internal sealed class AstDateAddExpression : AstExpression
    {
        ...
        public override AstNodeType NodeType => AstNodeType.DateAddExpression;
        ...
        {
            return visitor.VisitDateAddExpression(this);
        }
        ...
        public AstDateAddExpression Update(
            AstExpression startDate,
            AstExpression unit,
            AstExpression amount,
