...
{
    internal sealed class AstAccumulatorField : AstNode
    {
        private readonly string _path;
        private readonly AstAccumulatorExpression _value;
        ...
        public override AstNodeType NodeType => AstNodeType.AccumulatorField;
        public string Path => _path;
        public AstAccumulatorExpression Value => _value;

        public override AstNode Accept(AstNodeVisitor visitor)
        {
            return visitor.VisitAccumulatorField(this);
        }
        ...
        public AstAccumulatorField Update(AstAccumulatorExpression value)
        {
            ...
            return new AstAccumulatorField(_path, value);
        }
    }
}
