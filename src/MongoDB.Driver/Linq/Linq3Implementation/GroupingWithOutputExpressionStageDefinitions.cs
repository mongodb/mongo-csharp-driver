...
namespace MongoDB.Driver.Linq.Linq3Implementation
{
    internal abstract class GroupingWithOutputExpressionStageDefinition<TInput, TGrouping, TOutput> : PipelineStageDefinition<TInput, TOutput>
    {
        ...
        public override RenderedPipelineStageDefinition<TOutput> Render(RenderArgs<TInput> args)
        {
            ...
            var groupingStage = RenderGroupingStage(args.SerializationDomain, inputSerializer, args.TranslationOptions, out var groupingSerializer);
            var projectStage = RenderProjectStage(args.SerializationDomain, groupingSerializer,  args.TranslationOptions, out var outputSerializer);
            ...
            out IBsonSerializer<TOutput> outputSerializer)
        {
            ...
            var context = TranslationContext.Create(serializationDomain, partiallyEvaluatedOutput, initialNode: parameter, initialSerializer: inputSerializer, translationOptions: translationOptions);
    ...
    internal sealed class BucketWithOutputExpressionStageDefinition<TInput, TValue, TOutput> : GroupingWithOutputExpressionStageDefinition<TInput, IGrouping<TValue, TInput>, TOutput>
    {
        ...
        protected override AstStage RenderGroupingStage(IBsonSerializationDomain serializationDomain,
            IBsonSerializer<TInput> inputSerializer,
            ExpressionTranslationOptions translationOptions,
            out IBsonSerializer<IGrouping<TValue, TInput>> groupingOutputSerializer)
        {
            ...
            var context = TranslationContext.Create(serializationDomain, partiallyEvaluatedGroupBy, initialNode: parameter, initialSerializer: inputSerializer, translationOptions: translationOptions);
