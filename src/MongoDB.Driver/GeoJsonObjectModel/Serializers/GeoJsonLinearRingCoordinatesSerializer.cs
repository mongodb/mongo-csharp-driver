...
namespace MongoDB.Driver.GeoJsonObjectModel.Serializers
{
    ...
    {
        // private fields
        private readonly IBsonSerializer<TCoordinates> _coordinatesSerializer;

        // constructors
        /// <summary>
        /// Initializes a new instance of the <see cref="GeoJsonLinearRingCoordinatesSerializer{TCoordinates}"/> class.
        /// </summary>
        public GeoJsonLinearRingCoordinatesSerializer()
            : this(BsonSerializer.DefaultSerializationDomain)
        {
        }

        internal GeoJsonLinearRingCoordinatesSerializer(IBsonSerializationDomain serializationDomain)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return
                base.Equals(obj) &&
                obj is GeoJsonLinearRingCoordinatesSerializer<TCoordinates> other &&
        ...
        protected override GeoJsonLinearRingCoordinates<TCoordinates> DeserializeValue(BsonDeserializationContext context, BsonDeserializationArgs args)
        {
        ...
        protected override void SerializeValue(BsonSerializationContext context, BsonSerializationArgs args, GeoJsonLinearRingCoordinates<TCoordinates> value)
        {
