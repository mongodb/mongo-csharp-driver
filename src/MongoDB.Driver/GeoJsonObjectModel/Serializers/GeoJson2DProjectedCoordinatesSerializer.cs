...
namespace MongoDB.Driver.GeoJsonObjectModel.Serializers
{
    ...
    public class GeoJson2DProjectedCoordinatesSerializer : ClassSerializerBase<GeoJson2DProjectedCoordinates>
    {
        ...
        protected override GeoJson2DProjectedCoordinates DeserializeValue(BsonDeserializationContext context, BsonDeserializationArgs args)
        {
        ...
        protected override void SerializeValue(BsonSerializationContext context, BsonSerializationArgs args, GeoJson2DProjectedCoordinates value)
        {
