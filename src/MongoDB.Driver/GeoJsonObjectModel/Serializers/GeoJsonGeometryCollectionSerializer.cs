...
namespace MongoDB.Driver.GeoJsonObjectModel.Serializers
{
    ...
    public class GeoJsonGeometryCollectionSerializer<TCoordinates> : ClassSerializerBase<GeoJsonGeometryCollection<TCoordinates>> where TCoordinates : GeoJsonCoordinates
    {
        ...
        internal GeoJsonGeometryCollectionSerializer(IBsonSerializationDomain serializationDomain)
        {
            _geometrySerializer = serializationDomain.SerializerRegistry.GetSerializer<GeoJsonGeometry<TCoordinates>>();
        ...
        public override bool Equals(object obj)
        {
            ...
            return
                base.Equals(obj) &&
                obj is GeoJsonGeometryCollectionSerializer<TCoordinates> other &&
                object.Equals(_geometrySerializer, other._geometrySerializer);
        }
