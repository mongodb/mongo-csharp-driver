...
namespace MongoDB.Driver.GeoJsonObjectModel.Serializers
{
    ...
    public class GeoJsonMultiLineStringSerializer<TCoordinates> : ClassSerializerBase<GeoJsonMultiLineString<TCoordinates>> where TCoordinates : GeoJsonCoordinates
    {
        ...
        internal GeoJsonMultiLineStringSerializer(IBsonSerializerRegistry serializerRegistry)
        {
            _coordinatesSerializer = serializerRegistry.GetSerializer<GeoJsonMultiLineStringCoordinates<TCoordinates>>();
        ...
        public override bool Equals(object obj)
        {
            ...
            return
                base.Equals(obj) &&
                obj is GeoJsonMultiLineStringSerializer<TCoordinates> other &&
