...
namespace MongoDB.Driver.GeoJsonObjectModel.Serializers
{
    ...
    public class GeoJsonLineStringSerializer<TCoordinates> : ClassSerializerBase<GeoJsonLineString<TCoordinates>> where TCoordinates : GeoJsonCoordinates
    {
        ...
        // private fields
        private readonly IBsonSerializer<GeoJsonLineStringCoordinates<TCoordinates>> _coordinatesSerializer;
        ...
        public override bool Equals(object obj)
        {
            ...
            return
                base.Equals(obj) &&
                obj is GeoJsonLineStringSerializer<TCoordinates> other &&
