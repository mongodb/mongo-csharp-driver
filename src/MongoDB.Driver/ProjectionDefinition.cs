...
namespace MongoDB.Driver
{
    ...
    public abstract class ProjectionDefinition<TSource>
    {
        ...
        /// <returns>A <see cref="BsonDocument"/>.</returns>
        public abstract BsonDocument Render(RenderArgs<TSource> renderArgs);
    ...
    public abstract class ProjectionDefinition<TSource, TProjection>
    {
        ...
        /// <param name="renderArgs">The render arguments.</param>
        /// <returns>A <see cref="RenderedProjectionDefinition{TProjection}"/>.</returns>
        public abstract RenderedProjectionDefinition<TProjection> Render(RenderArgs<TSource> renderArgs);
    ...
    public sealed class BsonDocumentProjectionDefinition<TSource, TProjection> : ProjectionDefinition<TSource, TProjection>
    {
        ...
        /// <inheritdoc />
        public override RenderedProjectionDefinition<TProjection> Render(RenderArgs<TSource> renderArgs)
        {
            return new RenderedProjectionDefinition<TProjection>(
                _document,
                _projectionSerializer ?? renderArgs.GetSerializer<TProjection>());
        }
    }
    ...
    public sealed class FindExpressionProjectionDefinition<TSource, TProjection> : ProjectionDefinition<TSource, TProjection>
    {
        ...
        public override RenderedProjectionDefinition<TProjection> Render(RenderArgs<TSource> renderArgs)
        {
            return renderArgs.LinqProvider.GetAdapter().TranslateExpressionToFindProjection(_expression, renderArgs.DocumentSerializer, renderArgs.SerializerRegistry);
        }
    }
    ...
    public sealed class ObjectProjectionDefinition<TSource> : ProjectionDefinition<TSource>
    {
        ...
        public override BsonDocument Render(RenderArgs<TSource> renderArgs)
        {
            var serializer = renderArgs.SerializerRegistry.GetSerializer(_obj.GetType());
    ...
    internal sealed class KnownResultTypeProjectionDefinitionAdapter<TSource, TProjection> : ProjectionDefinition<TSource, TProjection>
    {
        ...
        public override RenderedProjectionDefinition<TProjection> Render(RenderArgs<TSource> renderArgs)
        {
            var renderedProjection = _projection.Render(renderArgs);
            return new RenderedProjectionDefinition<TProjection>(
              renderedProjection,
              _projectionSerializer ?? renderArgs.GetSerializer<TProjection>());
        }
