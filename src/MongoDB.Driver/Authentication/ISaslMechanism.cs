...
namespace MongoDB.Driver.Authentication
{
    ...
    public interface ISaslMechanism
    {
        ...
        BsonDocument CustomizeSaslStartCommand(BsonDocument startCommand);
        ...
        ISaslStep Initialize(SaslConversation conversation, ConnectionDescription description);
        ...
        bool TryHandleAuthenticationException(
