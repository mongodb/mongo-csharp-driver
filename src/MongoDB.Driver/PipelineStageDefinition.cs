...
namespace MongoDB.Driver
{
    ...
    public interface IPipelineStageDefinition
    {
        ...
        [Obsolete("Use other Render overload instead.")]
    ...
    public abstract class PipelineStageDefinition<TInput, TOutput> : IPipelineStageDefinition
    {
        ...
        {
            return Render(new RenderArgs<TInput>(inputSerializer, serializerRegistry, linqProvider));
        }
        ...
        /// <returns>A <see cref="RenderedPipelineStageDefinition{TOutput}" /></returns>
        public abstract RenderedPipelineStageDefinition<TOutput> Render(RenderArgs<TInput> renderArgs);
        ...
        {
            var renderedStage = Render(new(inputSerializer, serializerRegistry, linqProvider));
        ...
        {
            return Render(new((IBsonSerializer<TInput>)inputSerializer, serializerRegistry, LinqProvider.V3));
        }
        ...
        {
            return Render(new((IBsonSerializer<TInput>)inputSerializer, serializerRegistry, linqProvider));
        }
    }
    ...
    public sealed class BsonDocumentPipelineStageDefinition<TInput, TOutput> : PipelineStageDefinition<TInput, TOutput>
    {
        ...
        /// <inheritdoc />
        public override RenderedPipelineStageDefinition<TOutput> Render(RenderArgs<TInput> renderArgs)
        {
            return new RenderedPipelineStageDefinition<TOutput>(
                OperatorName,
                _document,
                _outputSerializer ?? renderArgs.GetSerializer<TOutput>());
        }
    }
