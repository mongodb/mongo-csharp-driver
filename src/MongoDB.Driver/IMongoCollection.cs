...
namespace MongoDB.Driver
{
    ...
    public interface IMongoCollection<TDocument> : IReadOnlyMongoCollection<TDocument>
    {
        ...
        /// </returns>
        Task<UpdateResult> UpdateManyAsync(Filter<TDocument> filter, Update2<TDocument> update, UpdateOptions options = null, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// The result of the update operation.
        /// </returns>
        Task<UpdateResult> UpdateOneAsync(Filter<TDocument> filter, Update2<TDocument> update, UpdateOptions options = null, CancellationToken cancellationToken = default(CancellationToken));
