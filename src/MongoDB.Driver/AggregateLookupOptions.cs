...
namespace MongoDB.Driver
{
    ...
    {
        private IBsonSerializer<TForeignDocument> _foreignSerializer;
        private IBsonSerializer<TResult> _resultSerializer;

        /// <summary>
        /// Gets or sets the foreign document serializer.
        /// </summary>
        public IBsonSerializer<TForeignDocument> ForeignSerializer
        {
            get { return _foreignSerializer; }
            set { _foreignSerializer = value; }
        }
