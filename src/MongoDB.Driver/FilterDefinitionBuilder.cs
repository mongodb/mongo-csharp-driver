...
namespace MongoDB.Driver
{
    ...
    internal sealed class AndFilterDefinition<TDocument> : FilterDefinition<TDocument>
    {
        ...
        public override BsonDocument Render(RenderArgs<TDocument> renderArgs)
        {
            ...
            if (renderArgs.RenderDollarForm)
            {
    ...
    internal sealed class ArrayOperatorFilterDefinition<TDocument, TItem> : FilterDefinition<TDocument>
    {
        ...
        public override BsonDocument Render(RenderArgs<TDocument> renderArgs)
        {
            ...
            if (renderedField.FieldSerializer != null)
            {
                ...
                itemSerializer = FieldValueSerializerHelper.GetSerializerForValueType(itemSerializationInfo.Serializer, renderArgs.SerializerRegistry, typeof(TItem));
            }
            else
            {
    ...
    internal sealed class ScalarElementMatchFilterDefinition<TDocument> : FilterDefinition<TDocument>
    {
        ...
        public override BsonDocument Render(RenderArgs<TDocument> renderArgs)
        {
            var document = _elementMatchFilter.Render(renderArgs);
        ...
        where TCoordinates : GeoJsonCoordinates
    {
        ...
        public override BsonDocument Render(RenderArgs<TDocument> renderArgs)
        {
            ...
            using (var bsonWriter = new BsonDocumentWriter(document))
            {
                ...
                renderArgs.SerializerRegistry.GetSerializer<GeoJsonGeometry<TCoordinates>>().Serialize(context, _geometry);
                bsonWriter.WriteEndDocument();
                bsonWriter.WriteEndDocument();
                bsonWriter.WriteEndDocument();
            }
        ...
        where TCoordinates : GeoJsonCoordinates
    {
        ...
        public override BsonDocument Render(RenderArgs<TDocument> renderArgs)
        {
            ...
            using (var bsonWriter = new BsonDocumentWriter(document))
            {
                ...
                bsonWriter.WriteStartDocument();
                bsonWriter.WriteName("$geometry");
                renderArgs.SerializerRegistry.GetSerializer<GeoJsonPoint<TCoordinates>>().Serialize(context, _point);
    ...
    internal sealed class NotFilterDefinition<TDocument> : FilterDefinition<TDocument>
    {
        ...
        public override BsonDocument Render(RenderArgs<TDocument> renderArgs)
        {
            var renderedFilter = _filter.Render(renderArgs);
    ...
    internal sealed class OperatorFilterDefinition<TDocument, TField> : FilterDefinition<TDocument>
    {
        ...
        public override BsonDocument Render(RenderArgs<TDocument> renderArgs)
        {
            var fieldRenderArgs = renderArgs with { PathRenderArgs = renderArgs.PathRenderArgs with { AllowScalarValueForArray = _allowScalarValueForArrayField } };
    ...
    internal sealed class ArrayAsSingleItemSimpleFilterDefinition<TDocument, TItem> : FilterDefinition<TDocument>
    {
        ...
        public override BsonDocument Render(RenderArgs<TDocument> renderArgs)
        {
            ...
            if (renderedField.FieldSerializer != null)
            {
                ...
                itemSerializer = (IBsonSerializer<TItem>)FieldValueSerializerHelper.GetSerializerForValueType(itemSerializationInfo.Serializer, renderArgs.SerializerRegistry, typeof(TItem));
            }
            else
            {
                itemSerializer = renderArgs.SerializerRegistry.GetSerializer<TItem>();
