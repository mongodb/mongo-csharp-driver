...
{
    public static class RangeMethodTranslator
    {
        public static ExpressionTranslation Translate(TranslationContext context, MethodCallExpression expression)
        {
            if (expression.Method.Is(EnumerableMethod.Range))
            {
                ...
                var startTranslation = ExpressionTranslator.Translate(context, startExpression);
        ...
        private static bool IsSimple(ExpressionTranslation translation)
        {
