...
namespace MongoDB.Driver.Linq3.Translators.QueryTranslators.Finalizers
{
    public class FirstOrDefaultFinalizer<TOutput> : IExecutableQueryFinalizer<TOutput, TOutput>
    {
