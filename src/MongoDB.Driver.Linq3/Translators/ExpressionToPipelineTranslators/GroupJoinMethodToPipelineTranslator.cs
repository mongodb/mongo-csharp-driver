...
{
    public static class GroupJoinMethodToPipelineTranslator
    {
        ...
        public static Pipeline Translate(TranslationContext context, MethodCallExpression expression)
        {
            ...
            if (method.Is(QueryableMethod.GroupJoin))
            {
                ...
                var wrapOuterStage = new AstProjectStage(
                    new AstProjectStageComputedFieldSpecification(new AstComputedField("_outer", new AstFieldExpression("$ROOT"))),
