...
{
    public static class ConstantExpressionToAggregationExpressionTranslator
    {
        public static AggregationExpression Translate(TranslationContext context, ConstantExpression expression)
        {
            ...
            if (value == null)
            {
                return new AggregationExpression(expression, BsonNull.Value, new BsonNullSerializer());
            }
            ...
            if (translatedValue != null)
            {
                ...
                return new AggregationExpression(expression, translatedValue, serializer);
            }
            ...
            return new AggregationExpression(expression, translatedValue, valueSerializer);
        }
    }
}
