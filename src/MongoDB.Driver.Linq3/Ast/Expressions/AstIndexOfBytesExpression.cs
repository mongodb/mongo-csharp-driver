...
{
    internal sealed class AstIndexOfBytesExpression : AstExpression
    {
        ...
        public AstIndexOfBytesExpression(
        ...
        public override AstNodeType NodeType => AstNodeType.IndexOfBytesExpression;
