...
Namespace MongoDB.DriverUnitTests.Linq
    ...
    Public Class SelectQueryTests
        ...
        Private Class CEqualityComparer
            ...
            Public Function Equals(ByVal x As C, ByVal y As C) As Boolean Implements IEqualityComparer(Of C).Equals
                Return x.Id.Equals(y.Id) AndAlso x.X.Equals(y.X) AndAlso x.Y.Equals(y.Y)
            End Function

            Public Function GetHashCode(ByVal obj As C) As Integer Implements IEqualityComparer(Of C).GetHashCode
        ...
        Private Class Int32EqualityComparer
            ...
            Public Function Equals(ByVal x As Integer, ByVal y As Integer) As Boolean Implements IEqualityComparer(Of Integer).Equals
                Return x = y
            End Function

            Public Function GetHashCode(ByVal obj As Integer) As Integer Implements IEqualityComparer(Of Integer).GetHashCode
                Return obj.GetHashCode()
            End Function
        End Class
        ...
        Public Sub TestFirstWithPredicateNoMatch()
            Dim ex = Assert.Throws(Of InvalidOperationException)(Function()
                                                                     Dim result = (From c In _collection.AsQueryable(Of C)()
