...
if [[ $OS =~ [Ww]indows.* ]]; then
  ...
  curl -Lfo ./dotnet-install.ps1 https://builds.dotnet.microsoft.com/dotnet/scripts/v1/dotnet-install/v1/dotnet-install.ps1
  ...
  curl -Lfo ./dotnet-install.sh https://builds.dotnet.microsoft.com/dotnet/scripts/v1/dotnet-install/v1/dotnet-install.sh
  echo "Installing .NET 8.0 SDK..."
