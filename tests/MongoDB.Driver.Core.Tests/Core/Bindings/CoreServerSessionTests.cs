...
{
    public class CoreServerSessionTests
    {
        [Fact]
        public void GenerateSessionId_should_return_expected_result()
        {
            var result = CoreServerSessionReflector.GenerateSessionId();
    ...
    internal static class CoreServerSessionReflector
    {
        public static BsonDocument GenerateSessionId()
        {
            var methodInfo = typeof(CoreServerSession).GetMethod("GenerateSessionId", BindingFlags.NonPublic | BindingFlags.Static);
