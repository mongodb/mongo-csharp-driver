...
namespace MongoDB.Driver.Core.Operations
{
    ...
    {
        #region static
        private static readonly Range<int> __dummyWireVersionRange = new Range<int>(0, 0);
        #endregion
        ...
        public void constructor_should_initialize_instance()
        {
            ...
            subject._wireVersionRange().Should().Be(__dummyWireVersionRange);
        }
        ...
        public void constructor_should_throw_when_cursor_is_null()
        {
            ...
            var exception = Record.Exception(() => new ChangeStreamCursor<BsonDocument>(null, documentSerializer, binding, changeStreamOperation, postBatchResumeToken, initialOperationTime, null, null, null, __dummyWireVersionRange));
        ...
        public void constructor_should_throw_when_documentSerializer_is_null()
        {
            ...
            var exception = Record.Exception(() => new ChangeStreamCursor<BsonDocument>(cursor, null, binding, changeStreamOperation, postBatchResumeToken, initialOperationTime, null, null, null, __dummyWireVersionRange));
        ...
        public void constructor_should_throw_when_binding_is_null()
        {
            ...
            var exception = Record.Exception(() => new ChangeStreamCursor<BsonDocument>(cursor, documentSerializer, null, changeStreamOperation, postBatchResumeToken, initialOperationTime, null, null, null, __dummyWireVersionRange));
        ...
        public void constructor_should_throw_when_changeStreamOperation_is_null()
        {
            ...
            var exception = Record.Exception(() => new ChangeStreamCursor<BsonDocument>(cursor, documentSerializer, binding, null, postBatchResumeToken, initialOperationTime, null, null, null, __dummyWireVersionRange));
        ...
        [Fact]
        public void constructor_should_throw_when_wireVersionRange_is_null()
        {
            var cursor = new Mock<IAsyncCursor<RawBsonDocument>>().Object;
            var documentSerializer = new Mock<IBsonSerializer<BsonDocument>>().Object;
            var initialOperationTime = new BsonTimestamp(3L);
            ...
            var argumnetNullException = exception.Should().BeOfType<ArgumentNullException>().Subject;
            argumnetNullException.ParamName.Should().Be("wireVersionRange");
        }
...
#pragma warning restore CS0618 // Type or member is obsolete
            ...
            BsonTimestamp initialOperationTime = null)
        {
            ...
            return new ChangeStreamCursor<BsonDocument>(cursor, documentSerializer, binding, changeStreamOperation, postBatchResumeToken, initialOperationTime, startAfter, resumeAfter, startAtOperationTime, __dummyWireVersionRange);
        }
    ...
    internal static class ChangeStreamCursorReflector
    {
        ...
        public static Range<int> _wireVersionRange<TDocument>(this IChangeStreamCursor<TDocument> cursor)
        {
            return (Range<int>)Reflector.GetFieldValue(cursor, nameof(_wireVersionRange));
        }
    }
}
