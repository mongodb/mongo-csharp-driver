...
namespace MongoDB.Driver.Tests.Specifications.crud.prose_tests
{
    ...
    public class CrudProseTests : LoggableTestClass
    {
            ...
            [Values(true, false)] bool isReplace)
        {
            ...
            using var client = CreateDisposableClient(null);
            var bulkWriteOptions = new ClientBulkWriteOptions { WriteConcern = WriteConcern.Unacknowledged };
        ...
        private DisposableMongoClient CreateDisposableClient(EventCapturer eventCapturer = null)
        {
