...
// Regression test for CSHARP-4802.
public class FindProjectSubDocumentIdTests : LinqIntegrationTest<FindProjectSubDocumentIdTests.ClassFixture>
{
    public FindProjectSubDocumentIdTests(ClassFixture fixture)
            : base(fixture)
        {
        }
