...
{
    // Regression test for CSHARP-5435.
    public class UpdateSetValueObjectTests : LinqIntegrationTest<UpdateSetValueObjectTests.ClassFixture>
    {
        public UpdateSetValueObjectTests(ClassFixture fixture)
            : base(fixture)
        {
        }
