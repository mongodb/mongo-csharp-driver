...
// Regression test for CSHARP-4079.
public class PositionalUpdateOperatorRenderingTests : Linq3IntegrationTest
{
    [Fact]
    public void Positional_operator_with_negative_one_array_index_should_throw()
    {
    ...
    [Fact]
    public void Positional_operator_with_negative_one_ElementAt_should_throw()
    {
        var collection = GetCollection<C>();
