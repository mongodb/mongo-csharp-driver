...
// Regression test for CSHARP-5928.
public class NonTranslatableExpressionThrowsTests : LinqIntegrationTest<NonTranslatableExpressionThrowsTests.ClassFixture>
{
    public NonTranslatableExpressionThrowsTests(ClassFixture fixture)
        : base(fixture)
    {
    }
