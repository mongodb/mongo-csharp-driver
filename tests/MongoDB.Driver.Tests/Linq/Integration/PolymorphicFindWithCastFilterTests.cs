...
// Regression test for CSHARP-4522.
public class PolymorphicFindWithCastFilterTests : Linq3IntegrationTest
{
    static PolymorphicFindWithCastFilterTests()
    {
        CreateClassMaps();
    }
...
public static class PolymorphicFindWithCastFilterTestsExpressionCombiner
{
