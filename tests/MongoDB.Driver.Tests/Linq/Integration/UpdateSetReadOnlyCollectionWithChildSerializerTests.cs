...
// Regression test for CSHARP-4820.
public class UpdateSetReadOnlyCollectionWithChildSerializerTests : LinqIntegrationTest<UpdateSetReadOnlyCollectionWithChildSerializerTests.ClassFixture>
{
    public UpdateSetReadOnlyCollectionWithChildSerializerTests(ClassFixture fixture)
        : base(fixture)
    {
    }

    static UpdateSetReadOnlyCollectionWithChildSerializerTests()
    {
