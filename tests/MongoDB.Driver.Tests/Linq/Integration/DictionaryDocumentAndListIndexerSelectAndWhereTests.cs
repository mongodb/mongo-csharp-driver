...
// Regression test for CSHARP-4708.
public class DictionaryDocumentAndListIndexerSelectAndWhereTests : LinqIntegrationTest<DictionaryDocumentAndListIndexerSelectAndWhereTests.ClassFixture>
{
    public DictionaryDocumentAndListIndexerSelectAndWhereTests(ClassFixture fixture)
            : base(fixture)
        {
        }
