...
{
    // Regression test for CSHARP-5916.
    public class PipelineUpdateConditionalNestedObjectTests : LinqIntegrationTest<PipelineUpdateConditionalNestedObjectTests.ClassFixture>
    {
        public PipelineUpdateConditionalNestedObjectTests(ClassFixture fixture)
            : base(fixture)
        {
        }
