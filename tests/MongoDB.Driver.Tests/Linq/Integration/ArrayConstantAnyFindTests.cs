...
// Regression test for CSHARP-5519.
public class ArrayConstantAnyFindTests : LinqIntegrationTest<ArrayConstantAnyFindTests.ClassFixture>
{
    public ArrayConstantAnyFindTests(ClassFixture fixture)
        : base(fixture)
    {
    }
