...
// Regression test for CSHARP-5850.
public class ClientSideProjectionInFindTests : LinqIntegrationTest<ClientSideProjectionInFindTests.ClassFixture>
{
    static ClientSideProjectionInFindTests()
    {
    ...
    public ClientSideProjectionInFindTests(ClassFixture fixture)
        : base(fixture)
    {
    }
