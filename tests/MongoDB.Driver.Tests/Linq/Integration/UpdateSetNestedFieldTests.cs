...
// Regression test for CSHARP-4967.
public class UpdateSetNestedFieldTests : LinqIntegrationTest<UpdateSetNestedFieldTests.ClassFixture>
{
    public UpdateSetNestedFieldTests(ClassFixture fixture)
        : base(fixture)
    {
    }
