...
// Regression test for CSHARP-5918.
public class PipelineUpdateWithToListTests : LinqIntegrationTest<PipelineUpdateWithToListTests.ClassFixture>
{
    public PipelineUpdateWithToListTests(ClassFixture fixture)
        : base(fixture)
    {
    }
