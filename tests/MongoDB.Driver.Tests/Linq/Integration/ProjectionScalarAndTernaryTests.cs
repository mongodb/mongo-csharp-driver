...
// Regression test for CSHARP-4593.
public class ProjectionScalarAndTernaryTests : LinqIntegrationTest<ProjectionScalarAndTernaryTests.ClassFixture>
{
    public ProjectionScalarAndTernaryTests(ClassFixture fixture)
        : base(fixture)
    {
    }
