...
// Regression test for CSHARP-4723.
public class FindOneAndModifyExpressionProjectionTests : LinqIntegrationTest<FindOneAndModifyExpressionProjectionTests.ClassFixture>
{
    public FindOneAndModifyExpressionProjectionTests(ClassFixture fixture)
            : base(fixture)
        {
        }
