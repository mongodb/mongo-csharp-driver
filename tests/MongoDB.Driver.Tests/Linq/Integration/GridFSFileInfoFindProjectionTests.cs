...
{
    // Regression test for CSHARP-5403.
    public class GridFSFileInfoFindProjectionTests : LinqIntegrationTest<GridFSFileInfoFindProjectionTests.ClassFixture>
    {
        public GridFSFileInfoFindProjectionTests(ClassFixture fixture)
            : base(fixture)
        {
        }
