...
// Regression test for CSHARP-4535.
public class QueryOverSubclassCollectionTests : LinqIntegrationTest<QueryOverSubclassCollectionTests.ClassFixture>
{
    public QueryOverSubclassCollectionTests(ClassFixture fixture)
        : base(fixture)
    {
    }
