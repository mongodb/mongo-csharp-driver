...
{
    // Regression test for CSHARP-5172.
    public class ElemMatchFilterAndPullFilterTests : LinqIntegrationTest<ElemMatchFilterAndPullFilterTests.ClassFixture>
    {
        public ElemMatchFilterAndPullFilterTests(ClassFixture fixture)
            : base(fixture)
        {
        }
