...
// Regression test for CSHARP-4937.
public class CompareToInFilterAndProjectionTests : LinqIntegrationTest<CompareToInFilterAndProjectionTests.ClassFixture>
{
    public CompareToInFilterAndProjectionTests(ClassFixture fixture)
        : base(fixture)
    {
    }
