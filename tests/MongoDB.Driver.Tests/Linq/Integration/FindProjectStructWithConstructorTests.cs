...
// Regression test for CSHARP-4524.
public class FindProjectStructWithConstructorTests : LinqIntegrationTest<FindProjectStructWithConstructorTests.ClassFixture>
{
    public FindProjectStructWithConstructorTests(ClassFixture fixture)
        : base(fixture)
    {
    }
