...
// Regression test for CSHARP-5506.
public class DictionaryWithGuidKeyQueryTests : LinqIntegrationTest<DictionaryWithGuidKeyQueryTests.ClassFixture>
{
    static DictionaryWithGuidKeyQueryTests()
    {
    ...
    public DictionaryWithGuidKeyQueryTests(ClassFixture fixture)
        : base(fixture)
    {
    }
