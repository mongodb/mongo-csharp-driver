...
// Regression test for CSHARP-4557.
public class DictionaryContainsKeyTests : LinqIntegrationTest<DictionaryContainsKeyTests.ClassFixture>
{
    public DictionaryContainsKeyTests(ClassFixture fixture)
        : base(fixture)
    {
    }
