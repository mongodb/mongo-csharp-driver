...
// Regression test for CSHARP-5587.
public class UpdateWithDiscriminatorTests : LinqIntegrationTest<UpdateWithDiscriminatorTests.ClassFixture>
{
    public UpdateWithDiscriminatorTests(ClassFixture fixture)
        : base(fixture)
    {
    }
