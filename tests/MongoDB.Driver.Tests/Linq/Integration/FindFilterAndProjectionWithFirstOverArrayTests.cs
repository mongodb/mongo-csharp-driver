...
// Regression test for CSHARP-5532.
public class FindFilterAndProjectionWithFirstOverArrayTests : LinqIntegrationTest<FindFilterAndProjectionWithFirstOverArrayTests.ClassFixture>
{
    ...
    public FindFilterAndProjectionWithFirstOverArrayTests(ClassFixture fixture)
        : base(fixture)
    {
    }
