...
// Regression test for CSHARP-4538.
public class FindProjectNullableValueTests : LinqIntegrationTest<FindProjectNullableValueTests.ClassFixture>
{
    public FindProjectNullableValueTests(ClassFixture fixture)
        : base(fixture)
    {
    }
