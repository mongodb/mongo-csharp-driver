...
// Regression test for CSHARP-5929.
public class IndexerOverCustomDocumentSerializerTests : LinqIntegrationTest<IndexerOverCustomDocumentSerializerTests.ClassFixture>
{
    public IndexerOverCustomDocumentSerializerTests(ClassFixture fixture)
        : base(fixture)
    {
    }
