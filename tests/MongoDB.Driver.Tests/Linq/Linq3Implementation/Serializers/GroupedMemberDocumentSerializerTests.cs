...
{
    // Regression test for CSHARP-4757.
    public class GroupedMemberDocumentSerializerTests : LinqIntegrationTest<GroupedMemberDocumentSerializerTests.ClassFixture>
    {
        public GroupedMemberDocumentSerializerTests(ClassFixture fixture)
            : base(fixture)
        {
        }
