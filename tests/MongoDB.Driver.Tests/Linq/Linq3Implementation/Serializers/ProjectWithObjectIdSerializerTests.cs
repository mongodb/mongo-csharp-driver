...
{
    // Regression test for CSHARP-2787.
    public class ProjectWithObjectIdSerializerTests : LinqIntegrationTest<ProjectWithObjectIdSerializerTests.ClassFixture>
    {
        public ProjectWithObjectIdSerializerTests(ClassFixture fixture)
        : base(fixture)
    {
    }
