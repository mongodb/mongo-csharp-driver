...
{
    // Regression test for CSHARP-4391.
    public class StructWithConstructorSerializationTests : LinqIntegrationTest<StructWithConstructorSerializationTests.ClassFixture>
    {
        public StructWithConstructorSerializationTests(ClassFixture fixture) : base(fixture)
        {
        }
