...
namespace MongoDB.Driver.Tests.Linq.Linq3Implementation.Serializers
{
    public class IEnumerableSerializerTests
    {
        ...
        {
            var x = new IEnumerableSerializer<int>(Int32Serializer.Instance);
        ...
        {
            var x = new IEnumerableSerializer<int>(Int32Serializer.Instance);
            var y = new IEnumerableSerializer<int>(Int32Serializer.Instance);
        ...
        public void Equals_with_not_equal_field_should_return_false()
        {
            ...
            var x = new IEnumerableSerializer<int>(itemSerializer1);
            var y = new IEnumerableSerializer<int>(itemSerializer2);
        ...
        internal class DerivedFromIEnumerableSerializer<TItem> : IEnumerableSerializer<TItem>
        {
