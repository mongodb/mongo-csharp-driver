...
{
    public class EnumAsIntegralTypeSerializerTests
    {
        ...
        {
            var x = new EnumAsIntegralTypeSerializer<E, int, int>(__enumSerializer1);
            var y = new DerivedFromEnumUnderlyingTypeSerializer<E, int, int>(__enumSerializer1);
        ...
        {
            var x = new EnumAsIntegralTypeSerializer<E, int, int>(__enumSerializer1);
            var y = new EnumAsIntegralTypeSerializer<E, int, int>(__enumSerializer1);
        ...
        {
            var x = new EnumAsIntegralTypeSerializer<E, int, int>(__enumSerializer1);
            var y = new EnumAsIntegralTypeSerializer<E, int, int>(__enumSerializer2);
        ...
        internal class DerivedFromEnumUnderlyingTypeSerializer<TEnum, TEnumUnderlyingType, TIntegralType> : EnumAsIntegralTypeSerializer<TEnum, TEnumUnderlyingType, TIntegralType>
            where TEnum : Enum
