...
{
    // Regression test for CSHARP-4048.
    public class IGroupingEnumerableMethodsTests : LinqIntegrationTest<IGroupingEnumerableMethodsTests.ClassFixture>
    {
        private static readonly bool FilterLimitIsSupported = Feature.FilterLimit.IsSupported(CoreTestConfiguration.MaxWireVersion);

        public IGroupingEnumerableMethodsTests(ClassFixture fixture)
            : base(fixture)
        {
        }
