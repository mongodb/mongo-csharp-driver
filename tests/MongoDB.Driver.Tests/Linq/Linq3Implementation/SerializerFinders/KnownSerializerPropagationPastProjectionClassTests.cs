...
// Regression test for CSHARP-4118.
public class KnownSerializerPropagationPastProjectionClassTests : LinqIntegrationTest<KnownSerializerPropagationPastProjectionClassTests.ClassFixture>
{
    public KnownSerializerPropagationPastProjectionClassTests(ClassFixture fixture)
        : base(fixture)
    {
    }
