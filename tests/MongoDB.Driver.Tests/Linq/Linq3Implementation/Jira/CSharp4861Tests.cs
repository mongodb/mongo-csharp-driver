...
{
    public class CSharp4861Tests : LinqIntegrationTest<CSharp4861Tests.CollectionFixture>
    {
        public CSharp4861Tests(ITestOutputHelper testOutputHelper, CollectionFixture fixture)
