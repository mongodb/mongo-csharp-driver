...
namespace MongoDB.Driver.Tests.Linq.Linq3Implementation.Jira
{
    public class CSharp4742Tests : Linq3IntegrationTest
    {
        ...
        public void ExpressionProjectionDefinition_with_identity_projection_Render_should_work(
            [Values(LinqProvider.V2, LinqProvider.V3)] LinqProvider linqProvider,
            [Values(true, false)] bool isAggregateMode)
        {
            var collection = GetCollection(linqProvider);
            ...
            var renderedProjection = projection.Render(new(sourceSerializer, serializerRegistry, linqProvider, isAggregateMode: isAggregateMode));
