...
{
    public class CSharp4772Tests : IntegrationTest<CSharp4772Tests.TestDataFixture>
    {
        public CSharp4772Tests(TestDataFixture fixture)
            : base(fixture)
        {
        }
        ...
        public class TestDataFixture : TemporaryCollectionFixture<Account>
        {
