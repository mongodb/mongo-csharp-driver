...
{
    public class CSharp4813Tests : LinqIntegrationTest<CSharp4813Tests.CollectionFixture>
    {
        public CSharp4813Tests(ITestOutputHelper testOutputHelper, CollectionFixture fixture)
