...
{
    public class CSharp4748Tests : IntegrationTest<CSharp4748Tests.TestDataFixture>
    {
        ...
        public CSharp4748Tests(TestDataFixture fixture)
            : base(fixture)
        {
        }
        ...
        public class TestDataFixture : TemporaryCollectionFixture<Translation>
        {
