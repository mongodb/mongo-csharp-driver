...
{
    public class CSharp4803Tests : LinqIntegrationTest<CSharp4803Tests.CollectionFixture>
    {
        public CSharp4803Tests(ITestOutputHelper testOutputHelper, CollectionFixture fixture)
