...
{
    public class CSharp4702Tests : LinqIntegrationTest<CSharp4702Tests.CollectionFixture>
    {
        public CSharp4702Tests(ITestOutputHelper testOutputHelper, CollectionFixture fixture)
