...
{
    // Regression test for CSHARP-4804.
    public class SliceProjectionInFindAndAggregateTests : LinqIntegrationTest<SliceProjectionInFindAndAggregateTests.ClassFixture>
    {
        public SliceProjectionInFindAndAggregateTests(ClassFixture fixture)
            : base(fixture)
        {
        }
