...
{
    // Regression test for CSHARP-4586.
    public class ProjectionWithConstructorTests : LinqIntegrationTest<ProjectionWithConstructorTests.ClassFixture>
    {
        public ProjectionWithConstructorTests(ClassFixture fixture)
            : base(fixture)
        {
        }
