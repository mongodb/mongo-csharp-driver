...
// Regression test for CSHARP-5529.
public class GroupFirstOrLastNestedFieldAccumulatorTests : LinqIntegrationTest<GroupFirstOrLastNestedFieldAccumulatorTests.ClassFixture>
{
    public GroupFirstOrLastNestedFieldAccumulatorTests(ClassFixture fixture)
        : base(fixture)
    {
    }
