...
{
    // Regression test for CSHARP-4888.
    public class GroupSumConditionalEnumRepresentationTests : LinqIntegrationTest<GroupSumConditionalEnumRepresentationTests.ClassFixture>
    {
        public GroupSumConditionalEnumRepresentationTests(ClassFixture fixture)
            : base(fixture)
        {
        }
