...
{
    // Regression test for CSHARP-2308.
    [Trait("Category", "Integration")]
    public class NestedSelectMapProjectionTests : LinqIntegrationTest<NestedSelectMapProjectionTests.ClassFixture>
    {
        public NestedSelectMapProjectionTests(ClassFixture fixture)
            : base(fixture)
        {
        }
