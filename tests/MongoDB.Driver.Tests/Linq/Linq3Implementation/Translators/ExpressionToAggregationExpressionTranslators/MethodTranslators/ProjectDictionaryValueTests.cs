...
{
    // Regression test for CSHARP-4592.
    public class ProjectDictionaryValueTests : LinqIntegrationTest<ProjectDictionaryValueTests.ClassFixture>
    {
        public ProjectDictionaryValueTests(ClassFixture fixture)
            : base(fixture)
        {
        }
