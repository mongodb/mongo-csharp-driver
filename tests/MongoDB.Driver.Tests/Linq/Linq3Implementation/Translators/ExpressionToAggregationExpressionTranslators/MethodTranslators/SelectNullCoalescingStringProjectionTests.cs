...
{
    // Regression test for CSHARP-5375.
    public class SelectNullCoalescingStringProjectionTests : LinqIntegrationTest<SelectNullCoalescingStringProjectionTests.ClassFixture>
    {
        public SelectNullCoalescingStringProjectionTests(ClassFixture fixture)
            : base(fixture)
        {
        }
