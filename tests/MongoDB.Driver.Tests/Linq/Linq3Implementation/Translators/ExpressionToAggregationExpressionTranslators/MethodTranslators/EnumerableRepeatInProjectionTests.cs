...
{
    // Regression test for CSHARP-4878.
    public class EnumerableRepeatInProjectionTests : LinqIntegrationTest<EnumerableRepeatInProjectionTests.ClassFixture>
    {
        public EnumerableRepeatInProjectionTests(ClassFixture fixture)
            : base(fixture)
        {
        }
