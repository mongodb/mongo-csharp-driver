...
// Regression test for CSHARP-5779.
public class SelectDictionaryAsArrayOfArraysKeysValuesProjectionTests : LinqIntegrationTest<SelectDictionaryAsArrayOfArraysKeysValuesProjectionTests.ClassFixture>
{
    private static readonly bool FilterLimitIsSupported = Feature.FilterLimit.IsSupported(CoreTestConfiguration.MaxWireVersion);

    static SelectDictionaryAsArrayOfArraysKeysValuesProjectionTests()
    {
    ...
    public SelectDictionaryAsArrayOfArraysKeysValuesProjectionTests(ClassFixture fixture)
        : base(fixture)
    {
    }
