...
{
    // Regression test for CSHARP-2107.
    public class WhereInProjectionFilterExpressionTests : LinqIntegrationTest<WhereInProjectionFilterExpressionTests.ClassFixture>
    {
        public WhereInProjectionFilterExpressionTests(ClassFixture fixture)
            : base(fixture)
        {
        }
