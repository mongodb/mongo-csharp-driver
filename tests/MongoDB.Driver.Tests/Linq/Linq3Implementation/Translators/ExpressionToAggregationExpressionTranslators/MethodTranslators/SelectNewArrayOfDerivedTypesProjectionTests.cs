...
// Regression test for CSHARP-5516.
public class SelectNewArrayOfDerivedTypesProjectionTests : LinqIntegrationTest<SelectNewArrayOfDerivedTypesProjectionTests.ClassFixture>
{
    public SelectNewArrayOfDerivedTypesProjectionTests(ClassFixture fixture)
        : base(fixture)
    {
    }
