...
{
    // Regression test for CSHARP-2472.
    public class NumericCastInGroupProjectionTests : LinqIntegrationTest<NumericCastInGroupProjectionTests.ClassFixture>
    {
        public NumericCastInGroupProjectionTests(ClassFixture fixture)
            : base(fixture)
        {
        }
