...
{
    // Regression test for CSHARP-4405.
    public class WeekMethodToAggregationExpressionTranslatorTests : LinqIntegrationTest<WeekMethodToAggregationExpressionTranslatorTests.ClassFixture>
    {
        public WeekMethodToAggregationExpressionTranslatorTests(ClassFixture fixture)
            : base(fixture)
        {
        }
