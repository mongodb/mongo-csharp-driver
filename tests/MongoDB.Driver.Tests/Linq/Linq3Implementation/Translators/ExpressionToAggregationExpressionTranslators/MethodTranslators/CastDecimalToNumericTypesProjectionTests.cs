...
{
    // Regression test for CSHARP-5180.
    public class CastDecimalToNumericTypesProjectionTests : LinqIntegrationTest<CastDecimalToNumericTypesProjectionTests.ClassFixture>
    {
        public CastDecimalToNumericTypesProjectionTests(ClassFixture fixture)
            : base(fixture)
        {
        }
