...
{
    // Regression test for CSHARP-4651.
    public class SelectWithCapturedTernaryProjectionTests : LinqIntegrationTest<SelectWithCapturedTernaryProjectionTests.ClassFixture>
    {
        public SelectWithCapturedTernaryProjectionTests(ClassFixture fixture)
            : base(fixture)
        {
        }
