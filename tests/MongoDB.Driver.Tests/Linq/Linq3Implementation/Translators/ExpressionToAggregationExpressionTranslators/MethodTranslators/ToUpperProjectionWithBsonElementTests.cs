...
{
    // Regression test for CSHARP-4049.
    public class ToUpperProjectionWithBsonElementTests : LinqIntegrationTest<ToUpperProjectionWithBsonElementTests.ClassFixture>
    {
        public ToUpperProjectionWithBsonElementTests(ClassFixture fixture)
            : base(fixture)
        {
        }
