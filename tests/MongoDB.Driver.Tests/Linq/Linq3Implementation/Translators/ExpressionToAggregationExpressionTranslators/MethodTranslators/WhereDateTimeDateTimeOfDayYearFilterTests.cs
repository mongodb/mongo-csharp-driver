...
{
    // Regression test for CSHARP-4743.
    public class WhereDateTimeDateTimeOfDayYearFilterTests : LinqIntegrationTest<WhereDateTimeDateTimeOfDayYearFilterTests.ClassFixture>
    {
        public WhereDateTimeDateTimeOfDayYearFilterTests(ClassFixture fixture)
            : base(fixture)
        {
        }
