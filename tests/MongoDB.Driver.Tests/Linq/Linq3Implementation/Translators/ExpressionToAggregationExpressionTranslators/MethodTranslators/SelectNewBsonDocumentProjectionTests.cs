...
{
    // Regression test for CSHARP-5190.
    public class SelectNewBsonDocumentProjectionTests : LinqIntegrationTest<SelectNewBsonDocumentProjectionTests.ClassFixture>
    {
        public SelectNewBsonDocumentProjectionTests(ClassFixture fixture)
            : base(fixture)
        {
        }
