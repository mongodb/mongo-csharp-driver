...
{
    // Regression test for CSHARP-5258.
    public class SelectFirstAndWhereOverArrayProjectionTests : LinqIntegrationTest<SelectFirstAndWhereOverArrayProjectionTests.ClassFixture>
    {
        public SelectFirstAndWhereOverArrayProjectionTests(ClassFixture fixture)
            : base(fixture)
        {
        }
