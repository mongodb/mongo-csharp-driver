...
{
    // Regression test for CSHARP-3236.
    public class SelectWithNestedWhereFilterExpressionTests : LinqIntegrationTest<SelectWithNestedWhereFilterExpressionTests.ClassFixture>
    {
        public SelectWithNestedWhereFilterExpressionTests(ClassFixture fixture)
            : base(fixture)
        {
        }
