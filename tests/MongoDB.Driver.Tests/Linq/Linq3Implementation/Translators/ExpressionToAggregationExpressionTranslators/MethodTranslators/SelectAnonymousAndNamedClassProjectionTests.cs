...
{
    // Regression test for CSHARP-4289.
    public class SelectAnonymousAndNamedClassProjectionTests : LinqIntegrationTest<SelectAnonymousAndNamedClassProjectionTests.ClassFixture>
    {
        public SelectAnonymousAndNamedClassProjectionTests(ClassFixture fixture)
            : base(fixture)
        {
        }
