...
// Regression test for CSHARP-5163.
public class SelectMultiplyMixedIntegerTypesTests : LinqIntegrationTest<SelectMultiplyMixedIntegerTypesTests.ClassFixture>
{
    public SelectMultiplyMixedIntegerTypesTests(ClassFixture fixture)
        : base(fixture)
    {
    }
