...
{
    // Regression test for CSHARP-3136.
    public class DateTimeToStringMethodTranslationTests : LinqIntegrationTest<DateTimeToStringMethodTranslationTests.ClassFixture>
    {
        public DateTimeToStringMethodTranslationTests(ClassFixture fixture)
            : base(fixture)
        {
        }
