...
{
    // Regression test for CSHARP-5321.
    public class ClientSideProjectionWithSumProjectionTests : LinqIntegrationTest<ClientSideProjectionWithSumProjectionTests.ClassFixture>
    {
        public ClientSideProjectionWithSumProjectionTests(ClassFixture fixture)
            : base(fixture)
        {
        }
