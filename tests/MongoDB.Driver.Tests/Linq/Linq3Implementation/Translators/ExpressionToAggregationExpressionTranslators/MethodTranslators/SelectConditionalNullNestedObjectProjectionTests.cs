...
{
    // Regression test for CSHARP-3614.
    public class SelectConditionalNullNestedObjectProjectionTests : LinqIntegrationTest<SelectConditionalNullNestedObjectProjectionTests.ClassFixture>
    {
        public SelectConditionalNullNestedObjectProjectionTests(ClassFixture fixture)
            : base(fixture)
        {
        }
