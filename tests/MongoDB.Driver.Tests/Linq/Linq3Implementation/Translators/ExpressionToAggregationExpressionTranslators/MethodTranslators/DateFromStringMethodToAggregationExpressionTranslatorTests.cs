...
namespace MongoDB.Driver.Tests.Linq.Linq3Implementation.Translators.ExpressionToAggregationExpressionTranslators.MethodTranslators
{
    ...
    {
        [Theory]
        [InlineData(1, "2023-12-26T12:34:56Z", LinqProvider.V2)]
        [InlineData(1, "2023-12-26T12:34:56Z", LinqProvider.V3)]
        [InlineData(2, "throws:FormatException", LinqProvider.V2)]
        [InlineData(2, "throws:FormatException", LinqProvider.V3)]
        [InlineData(3, "throws:FormatException", LinqProvider.V2)]
        [InlineData(3, "throws:FormatException", LinqProvider.V3)]
        [InlineData(4, "throws:MongoCommandException", LinqProvider.V2)]
        [InlineData(4, "throws:MongoCommandException", LinqProvider.V3)]
        public void DateTime_Parse_should_work(int id, string expectedResult, LinqProvider linqProvider)
        {
            ...
            var expectedStages = linqProvider == LinqProvider.V2 ?
                ...
                {
                    $"{{ $match : {{ _id : {id} }} }}",
                    "{ $project : { __fld0 : { $dateFromString : { dateString : '$S' } }, _id : 0 } }"
                } :
                new[]
                {
                    $"{{ $match : {{ _id : {id} }} }}",
        ...
        [Theory]
        [InlineData(1, "throws:NotSupportedException", LinqProvider.V2)]
        [InlineData(1, "2023-12-26T12:34:56Z", LinqProvider.V3)]
        [InlineData(2, "throws:FormatException", LinqProvider.V3)]
        [InlineData(3, "throws:FormatException", LinqProvider.V3)]
        [InlineData(4, "throws:MongoCommandException", LinqProvider.V3)]
        public void MongoDBFunctions_DateFromString_should_work(int id, string expectedResult, LinqProvider linqProvider)
        {
            var collection = GetCollection(linqProvider);
        ...
        [InlineData(3, "throws:FormatException", LinqProvider.V3)]
        [InlineData(4, "throws:MongoCommandException", LinqProvider.V3)]
        public void MongoDBFunctions_DateFromString_with_format_should_work(int id, string expectedResult, LinqProvider linqProvider)
        {
        ...
        [InlineData(3, "throws:FormatException", LinqProvider.V3)]
        [InlineData(4, "throws:MongoCommandException", LinqProvider.V3)]
        public void MongoDBFunctions_DateFromString_with_format_and_timezone_should_work(int id, string expectedResult, LinqProvider linqProvider)
        {
            RequireServer.Check().Supports(Feature.DateFromStringFormatArgument);
            var collection = GetCollection(linqProvider);
        ...
        [InlineData(1, "throws:NotSupportedException", LinqProvider.V2)]
        [InlineData(1, "2023-12-26T12:34:56Z", LinqProvider.V3)]
        [InlineData(2, "0001-01-01T00:00:00Z", LinqProvider.V3)]
        [InlineData(3, "0001-01-01T00:00:00Z", LinqProvider.V3)]
        [InlineData(4, "1111-11-11T11:11:11Z", LinqProvider.V3)]
        [InlineData(5, "default", LinqProvider.V3)]
        [InlineData(6, "default", LinqProvider.V3)]
        [InlineData(7, "1111-11-11T11:11:11Z", LinqProvider.V3)]
        public void MongoDBFunctions_DateFromString_with_format_and_timezone_and_onError_and_onNull_should_work(int id, string expectedResult, LinqProvider linqProvider)
        {
            RequireServer.Check().Supports(Feature.DateFromStringFormatArgument);
            var collection = GetCollection(linqProvider);
