...
{
    // Regression test for CSHARP-3958.
    public class OrderByThenByInProjectionToSortArrayTests : LinqIntegrationTest<OrderByThenByInProjectionToSortArrayTests.ClassFixture>
    {
        public OrderByThenByInProjectionToSortArrayTests(ClassFixture fixture)
            : base(fixture)
        {
        }
