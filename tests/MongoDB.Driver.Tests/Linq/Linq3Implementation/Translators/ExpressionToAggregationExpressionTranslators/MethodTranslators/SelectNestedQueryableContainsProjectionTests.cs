...
// Regression test for CSHARP-5463.
public class SelectNestedQueryableContainsProjectionTests : LinqIntegrationTest<SelectNestedQueryableContainsProjectionTests.ClassFixture>
{
    public SelectNestedQueryableContainsProjectionTests(ClassFixture fixture)
        : base(fixture)
    {
    }
