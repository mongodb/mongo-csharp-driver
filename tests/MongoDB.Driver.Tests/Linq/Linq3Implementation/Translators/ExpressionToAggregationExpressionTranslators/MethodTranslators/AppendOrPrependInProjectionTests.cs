...
{
    // Regression test for CSHARP-4872.
    public class AppendOrPrependInProjectionTests : LinqIntegrationTest<AppendOrPrependInProjectionTests.ClassFixture>
    {
        public AppendOrPrependInProjectionTests(ClassFixture fixture)
            : base(fixture)
        {
        }
