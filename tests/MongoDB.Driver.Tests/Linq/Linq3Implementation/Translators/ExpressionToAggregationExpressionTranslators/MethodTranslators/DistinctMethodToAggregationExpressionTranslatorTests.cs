...
{
    public class DistinctMethodToAggregationExpressionTranslatorTests : LinqIntegrationTest<DistinctMethodToAggregationExpressionTranslatorTests.ClassFixture>
    {
        public DistinctMethodToAggregationExpressionTranslatorTests(ClassFixture fixture)
            : base(fixture)
        {
        }

        [Fact]
        public void Enumerable_Distinct_should_work()
        {
            ...
            results[3].Should().BeEquivalentTo(1, 2);
        }
