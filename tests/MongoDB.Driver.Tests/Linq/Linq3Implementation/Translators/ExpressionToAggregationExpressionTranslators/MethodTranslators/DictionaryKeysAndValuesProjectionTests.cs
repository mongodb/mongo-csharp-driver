...
{
    // Regression test for CSHARP-4317.
    public class DictionaryKeysAndValuesProjectionTests : LinqIntegrationTest<DictionaryKeysAndValuesProjectionTests.ClassFixture>
    {
        public DictionaryKeysAndValuesProjectionTests(ClassFixture fixture)
            : base(fixture)
        {
        }
