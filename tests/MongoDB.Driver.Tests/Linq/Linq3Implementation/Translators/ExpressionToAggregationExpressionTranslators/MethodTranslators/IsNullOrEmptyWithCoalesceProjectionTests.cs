...
{
    // Regression test for CSHARP-4057.
    public class IsNullOrEmptyWithCoalesceProjectionTests : LinqIntegrationTest<IsNullOrEmptyWithCoalesceProjectionTests.ClassFixture>
    {
        public IsNullOrEmptyWithCoalesceProjectionTests(ClassFixture fixture)
            : base(fixture)
        {
        }
