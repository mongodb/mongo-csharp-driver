...
{
    // Regression test for CSHARP-3924.
    public class ProjectionAndFilterWithTupleConstructorAndItemAccessTests : LinqIntegrationTest<ProjectionAndFilterWithTupleConstructorAndItemAccessTests.ClassFixture>
    {
        public ProjectionAndFilterWithTupleConstructorAndItemAccessTests(ClassFixture fixture)
            : base(fixture)
        {
        }
