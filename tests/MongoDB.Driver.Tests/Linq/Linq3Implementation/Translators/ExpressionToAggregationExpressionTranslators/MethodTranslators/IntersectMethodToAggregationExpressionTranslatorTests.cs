...
{
    public class IntersectMethodToAggregationExpressionTranslatorTests : LinqIntegrationTest<IntersectMethodToAggregationExpressionTranslatorTests.ClassFixture>
    {
        public IntersectMethodToAggregationExpressionTranslatorTests(ClassFixture fixture)
            : base(fixture)
        {
        }
