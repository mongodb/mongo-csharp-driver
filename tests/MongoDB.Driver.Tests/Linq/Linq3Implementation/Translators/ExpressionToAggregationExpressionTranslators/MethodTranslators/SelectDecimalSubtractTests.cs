...
{
    // Regression test for CSHARP-5295.
    public class SelectDecimalSubtractTests : LinqIntegrationTest<SelectDecimalSubtractTests.ClassFixture>
    {
        public SelectDecimalSubtractTests(ClassFixture fixture)
            : base(fixture)
        {
        }
