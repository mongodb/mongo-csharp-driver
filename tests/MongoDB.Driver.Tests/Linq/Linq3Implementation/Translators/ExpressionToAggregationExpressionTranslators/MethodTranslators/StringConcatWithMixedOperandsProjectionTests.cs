...
{
    // Regression test for CSHARP-5071.
    public class StringConcatWithMixedOperandsProjectionTests : LinqIntegrationTest<StringConcatWithMixedOperandsProjectionTests.ClassFixture>
    {
        public StringConcatWithMixedOperandsProjectionTests(ClassFixture fixture)
            : base(fixture)
        {
        }
