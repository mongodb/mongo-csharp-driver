...
{
    // Regression test for CSHARP-3946.
    public class WhereWithLimitInProjectionToFilterTests : LinqIntegrationTest<WhereWithLimitInProjectionToFilterTests.ClassFixture>
    {
        public WhereWithLimitInProjectionToFilterTests(ClassFixture fixture)
            : base(fixture)
        {
        }
