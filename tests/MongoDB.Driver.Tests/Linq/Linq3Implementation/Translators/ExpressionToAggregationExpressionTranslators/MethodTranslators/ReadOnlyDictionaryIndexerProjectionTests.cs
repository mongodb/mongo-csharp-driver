...
{
    // Regression test for CSHARP-5171.
    public class ReadOnlyDictionaryIndexerProjectionTests : LinqIntegrationTest<ReadOnlyDictionaryIndexerProjectionTests.ClassFixture>
    {
        public ReadOnlyDictionaryIndexerProjectionTests(ClassFixture fixture)
            : base(fixture)
        {
        }
