...
// Regression test for CSHARP-5730.
public class SelectStringCompareProjectionTests : LinqIntegrationTest<SelectStringCompareProjectionTests.ClassFixture>
{
    public SelectStringCompareProjectionTests(ClassFixture fixture)
        : base(fixture)
    {
    }
