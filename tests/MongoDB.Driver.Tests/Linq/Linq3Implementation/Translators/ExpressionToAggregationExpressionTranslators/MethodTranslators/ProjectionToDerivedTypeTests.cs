...
{
    // Regression test for CSHARP-4567.
    public class ProjectionToDerivedTypeTests : LinqIntegrationTest<ProjectionToDerivedTypeTests.ClassFixture>
    {
        public ProjectionToDerivedTypeTests(ClassFixture fixture)
            : base(fixture)
        {
        }
