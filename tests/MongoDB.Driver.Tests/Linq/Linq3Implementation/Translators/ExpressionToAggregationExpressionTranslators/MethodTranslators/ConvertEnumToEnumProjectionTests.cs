...
{
    // Regression test for CSHARP-5043.
    public class ConvertEnumToEnumProjectionTests : LinqIntegrationTest<ConvertEnumToEnumProjectionTests.ClassFixture>
    {
        public ConvertEnumToEnumProjectionTests(ClassFixture fixture)
            : base(fixture)
        {
        }
