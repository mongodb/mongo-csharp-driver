...
{
    // Regression test for CSHARP-4781.
    public class DefaultIfEmptyInSelectProjectionTests : LinqIntegrationTest<DefaultIfEmptyInSelectProjectionTests.ClassFixture>
    {
        public DefaultIfEmptyInSelectProjectionTests(ClassFixture fixture)
            : base(fixture)
        {
        }
