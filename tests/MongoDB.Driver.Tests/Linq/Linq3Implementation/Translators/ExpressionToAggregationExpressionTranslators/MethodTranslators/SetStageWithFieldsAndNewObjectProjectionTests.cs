...
{
    // Regression test for CSHARP-4747.
    public class SetStageWithFieldsAndNewObjectProjectionTests : LinqIntegrationTest<SetStageWithFieldsAndNewObjectProjectionTests.ClassFixture>
    {
        public SetStageWithFieldsAndNewObjectProjectionTests(ClassFixture fixture)
            : base(fixture)
        {
        }
