...
// Regression test for CSHARP-5628.
public class SelectBooleanConditionalProjectionTests : LinqIntegrationTest<SelectBooleanConditionalProjectionTests.ClassFixture>
{
    public SelectBooleanConditionalProjectionTests(ClassFixture fixture)
        : base(fixture)
    {
    }
