...
{
    // Regression test for CSHARP-4410.
    public class SelectEnumComparisonToAggregationExpressionTranslatorTests : LinqIntegrationTest<SelectEnumComparisonToAggregationExpressionTranslatorTests.ClassFixture>
    {
        ...
        public SelectEnumComparisonToAggregationExpressionTranslatorTests(ClassFixture fixture)
            : base(fixture)
        {
        }
        ...
        static SelectEnumComparisonToAggregationExpressionTranslatorTests()
        {
