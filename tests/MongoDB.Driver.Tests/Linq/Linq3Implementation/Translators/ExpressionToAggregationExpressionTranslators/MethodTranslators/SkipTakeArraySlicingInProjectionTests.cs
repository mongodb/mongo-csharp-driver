...
{
    // Regression test for CSHARP-4882.
    public class SkipTakeArraySlicingInProjectionTests : LinqIntegrationTest<SkipTakeArraySlicingInProjectionTests.ClassFixture>
    {
        public SkipTakeArraySlicingInProjectionTests(ClassFixture fixture)
            : base(fixture)
        {
        }
