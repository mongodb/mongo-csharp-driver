...
{
    // Regression test for CSHARP-4985.
    public class SelectNullableIntAddProjectionTests : LinqIntegrationTest<SelectNullableIntAddProjectionTests.ClassFixture>
    {
        public SelectNullableIntAddProjectionTests(ClassFixture fixture)
            : base(fixture)
        {
        }
