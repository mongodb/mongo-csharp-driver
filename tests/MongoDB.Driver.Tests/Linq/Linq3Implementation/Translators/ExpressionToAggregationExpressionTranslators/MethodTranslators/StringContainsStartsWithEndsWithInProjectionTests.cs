...
{
    // Regression test for CSHARP-4100.
    public class StringContainsStartsWithEndsWithInProjectionTests : LinqIntegrationTest<StringContainsStartsWithEndsWithInProjectionTests.ClassFixture>
    {
        public StringContainsStartsWithEndsWithInProjectionTests(ClassFixture fixture) : base(fixture)
        {
        }
