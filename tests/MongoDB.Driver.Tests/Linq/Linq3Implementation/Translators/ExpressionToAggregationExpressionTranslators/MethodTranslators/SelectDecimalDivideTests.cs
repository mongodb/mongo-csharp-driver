...
{
    // Regression test for CSHARP-4993.
    public class SelectDecimalDivideTests : LinqIntegrationTest<SelectDecimalDivideTests.ClassFixture>
    {
        public SelectDecimalDivideTests(ClassFixture fixture)
            : base(fixture)
        {
        }
