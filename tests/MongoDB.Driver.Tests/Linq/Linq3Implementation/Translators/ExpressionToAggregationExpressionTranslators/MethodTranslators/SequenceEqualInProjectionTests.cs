...
{
    // Regression test for CSHARP-4880.
    public class SequenceEqualInProjectionTests : LinqIntegrationTest<SequenceEqualInProjectionTests.ClassFixture>
    {
        public SequenceEqualInProjectionTests(ClassFixture fixture)
            : base(fixture)
        {
        }
