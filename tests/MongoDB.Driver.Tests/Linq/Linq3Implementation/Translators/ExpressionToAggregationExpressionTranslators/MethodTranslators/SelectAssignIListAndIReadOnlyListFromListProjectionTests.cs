...
{
    // Regression test for CSHARP-4731.
    public class SelectAssignIListAndIReadOnlyListFromListProjectionTests : LinqIntegrationTest<SelectAssignIListAndIReadOnlyListFromListProjectionTests.ClassFixture>
    {
        public SelectAssignIListAndIReadOnlyListFromListProjectionTests(ClassFixture fixture)
            : base(fixture)
        {
        }
