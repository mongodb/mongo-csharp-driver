...
{
    // Regression test for CSHARP-4486.
    public class BooleanAndBitwiseOperatorsToAggregationExpressionTranslatorTests : LinqIntegrationTest<BooleanAndBitwiseOperatorsToAggregationExpressionTranslatorTests.ClassFixture>
    {
        public BooleanAndBitwiseOperatorsToAggregationExpressionTranslatorTests(ClassFixture fixture)
            : base(fixture)
        {
        }
