...
{
    // Regression test for CSHARP-4876.
    public class OfTypeInProjectionTests : LinqIntegrationTest<OfTypeInProjectionTests.ClassFixture>
    {
        public OfTypeInProjectionTests(ClassFixture fixture)
            : base(fixture)
        {
        }
