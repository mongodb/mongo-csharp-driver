...
{
    // Regression test for CSHARP-4883.
    public class SkipWhileTakeWhileArraySlicingInProjectionTests : LinqIntegrationTest<SkipWhileTakeWhileArraySlicingInProjectionTests.ClassFixture>
    {
        public SkipWhileTakeWhileArraySlicingInProjectionTests(ClassFixture fixture)
            : base(fixture)
        {
        }
