...
{
    // Regression test for CSHARP-4688.
    public class TerminalOperatorLoggedStagesTests : LinqIntegrationTest<TerminalOperatorLoggedStagesTests.ClassFixture>
    {
        public TerminalOperatorLoggedStagesTests(ClassFixture fixture)
            : base(fixture)
        {
        }
