...
{
    // Regression test for CSHARP-4763.
    public class ClientSideProjectionExecutionTests : LinqIntegrationTest<ClientSideProjectionExecutionTests.ClassFixture>
    {
        public ClientSideProjectionExecutionTests(ClassFixture fixture)
            : base(fixture)
        {
        }
