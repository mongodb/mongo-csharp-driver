...
{
    // Regression test for CSHARP-4684.
    public class GetLoggedStagesRetrievalTests : LinqIntegrationTest<GetLoggedStagesRetrievalTests.ClassFixture>
    {
        public GetLoggedStagesRetrievalTests(ClassFixture fixture)
            : base(fixture)
        {
        }
