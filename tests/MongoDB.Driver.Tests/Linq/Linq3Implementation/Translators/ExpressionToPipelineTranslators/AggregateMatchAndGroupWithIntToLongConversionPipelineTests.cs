...
// Regression test for CSHARP-5606.
public class AggregateMatchAndGroupWithIntToLongConversionPipelineTests : LinqIntegrationTest<AggregateMatchAndGroupWithIntToLongConversionPipelineTests.ClassFixture>
{
    public AggregateMatchAndGroupWithIntToLongConversionPipelineTests(ClassFixture fixture)
        : base(fixture)
    {
    }
