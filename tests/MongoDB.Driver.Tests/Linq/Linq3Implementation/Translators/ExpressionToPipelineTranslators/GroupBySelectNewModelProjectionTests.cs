...
{
    // Regression test for CSHARP-4658.
    public class GroupBySelectNewModelProjectionTests : LinqIntegrationTest<GroupBySelectNewModelProjectionTests.ClassFixture>
    {
        public GroupBySelectNewModelProjectionTests(ClassFixture fixture)
            : base(fixture)
        {
        }
