...
{
    // Regression test for CSHARP-3713.
    public class SelectManyDefaultIfEmptyPipelineTests : LinqIntegrationTest<SelectManyDefaultIfEmptyPipelineTests.ClassFixture>
    {
        public SelectManyDefaultIfEmptyPipelineTests(ClassFixture fixture)
            : base(fixture)
        {
        }
