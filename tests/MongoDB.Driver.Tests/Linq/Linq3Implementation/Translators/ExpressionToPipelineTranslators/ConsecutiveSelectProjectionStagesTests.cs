...
{
    // Regression test for CSHARP-3197.
    public class ConsecutiveSelectProjectionStagesTests : LinqIntegrationTest<ConsecutiveSelectProjectionStagesTests.ClassFixture>
    {
        public ConsecutiveSelectProjectionStagesTests(ClassFixture fixture)
            : base(fixture)
        {
        }
