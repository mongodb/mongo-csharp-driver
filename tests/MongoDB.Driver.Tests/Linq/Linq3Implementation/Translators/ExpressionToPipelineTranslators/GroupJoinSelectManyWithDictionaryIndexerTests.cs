...
{
    // Regression test for CSHARP-1775.
    public class GroupJoinSelectManyWithDictionaryIndexerTests : LinqIntegrationTest<GroupJoinSelectManyWithDictionaryIndexerTests.ClassFixture>
    {
        public GroupJoinSelectManyWithDictionaryIndexerTests(ClassFixture fixture)
        : base(fixture)
    {
    }
