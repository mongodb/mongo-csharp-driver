...
{
    // Regression test for CSHARP-3965.
    public class OrderByThenByExpressionAndFieldSortStageTests : LinqIntegrationTest<OrderByThenByExpressionAndFieldSortStageTests.ClassFixture>
    {
        public OrderByThenByExpressionAndFieldSortStageTests(ClassFixture fixture)
            : base(fixture)
        {
        }
