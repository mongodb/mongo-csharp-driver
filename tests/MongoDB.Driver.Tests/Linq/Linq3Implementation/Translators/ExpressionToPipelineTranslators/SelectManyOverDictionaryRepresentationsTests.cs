...
{
    // Regression test for CSHARP-1913.
    public class SelectManyOverDictionaryRepresentationsTests : LinqIntegrationTest<SelectManyOverDictionaryRepresentationsTests.ClassFixture>
    {
        public SelectManyOverDictionaryRepresentationsTests(ClassFixture fixture)
        : base(fixture)
    {
    }
