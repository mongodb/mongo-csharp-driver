...
{
    // Regression test for CSHARP-5081.
    public class ChainedAndNestedSelectManyPipelineTests : LinqIntegrationTest<ChainedAndNestedSelectManyPipelineTests.ClassFixture>
    {
        public ChainedAndNestedSelectManyPipelineTests(ClassFixture fixture)
            : base(fixture)
        {
        }
