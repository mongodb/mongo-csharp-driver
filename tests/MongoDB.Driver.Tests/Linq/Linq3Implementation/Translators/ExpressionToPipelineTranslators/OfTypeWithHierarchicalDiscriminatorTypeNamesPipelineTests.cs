...
{
// Regression test for CSHARP-4040.
public class OfTypeWithHierarchicalDiscriminatorTypeNamesPipelineTests : LinqIntegrationTest<OfTypeWithHierarchicalDiscriminatorTypeNamesPipelineTests.ClassFixture>
{
    public OfTypeWithHierarchicalDiscriminatorTypeNamesPipelineTests(ClassFixture fixture)
        : base(fixture)
    {
    }
