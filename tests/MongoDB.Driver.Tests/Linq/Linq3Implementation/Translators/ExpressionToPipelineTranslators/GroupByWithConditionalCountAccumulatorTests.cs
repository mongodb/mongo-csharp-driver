...
{
    // Regression test for CSHARP-4744.
    public class GroupByWithConditionalCountAccumulatorTests : LinqIntegrationTest<GroupByWithConditionalCountAccumulatorTests.ClassFixture>
    {
        public GroupByWithConditionalCountAccumulatorTests(ClassFixture fixture)
            : base(fixture)
        {
        }
