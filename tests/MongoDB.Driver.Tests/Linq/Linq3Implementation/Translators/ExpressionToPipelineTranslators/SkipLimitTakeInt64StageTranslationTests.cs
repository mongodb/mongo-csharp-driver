...
{
    // Regression test for CSHARP-4445.
    public class SkipLimitTakeInt64StageTranslationTests : LinqIntegrationTest<SkipLimitTakeInt64StageTranslationTests.ClassFixture>
    {
        public SkipLimitTakeInt64StageTranslationTests(ClassFixture fixture)
            : base(fixture)
        {
        }
