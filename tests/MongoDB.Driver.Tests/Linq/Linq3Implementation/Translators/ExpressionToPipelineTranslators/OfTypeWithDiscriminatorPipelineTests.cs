...
{
    // Regression test for CSHARP-5286.
    public class OfTypeWithDiscriminatorPipelineTests : LinqIntegrationTest<OfTypeWithDiscriminatorPipelineTests.ClassFixture>
    {
        static OfTypeWithDiscriminatorPipelineTests()
        {
        ...
        public OfTypeWithDiscriminatorPipelineTests(ClassFixture fixture)
            : base(fixture)
        {
        }
