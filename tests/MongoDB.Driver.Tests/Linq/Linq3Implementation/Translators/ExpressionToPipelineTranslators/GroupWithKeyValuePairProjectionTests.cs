...
{
    // Regression test for CSHARP-1326.
    public class GroupWithKeyValuePairProjectionTests : LinqIntegrationTest<GroupWithKeyValuePairProjectionTests.ClassFixture>
    {
        public GroupWithKeyValuePairProjectionTests(ClassFixture fixture)
            : base(fixture)
        {
        }
