...
{
    // Regression test for CSHARP-4700.
    public class OrderByGroupCountPipelineTests : LinqIntegrationTest<OrderByGroupCountPipelineTests.ClassFixture>
    {
        public OrderByGroupCountPipelineTests(ClassFixture fixture)
            : base(fixture)
        {
        }
