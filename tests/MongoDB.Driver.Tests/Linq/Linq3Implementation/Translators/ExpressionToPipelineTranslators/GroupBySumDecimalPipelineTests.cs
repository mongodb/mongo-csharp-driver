...
{
    // Regression test for CSHARP-4468.
    public class GroupBySumDecimalPipelineTests : LinqIntegrationTest<GroupBySumDecimalPipelineTests.ClassFixture>
    {
        public GroupBySumDecimalPipelineTests(ClassFixture fixture)
            : base(fixture)
        {
        }
