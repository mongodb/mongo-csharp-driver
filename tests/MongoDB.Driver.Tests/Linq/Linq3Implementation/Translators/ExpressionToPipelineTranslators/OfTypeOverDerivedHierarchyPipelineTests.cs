...
{
    // Regression test for CSHARP-5481.
    public class OfTypeOverDerivedHierarchyPipelineTests : LinqIntegrationTest<OfTypeOverDerivedHierarchyPipelineTests.ClassFixture>
    {
        public OfTypeOverDerivedHierarchyPipelineTests(ClassFixture fixture)
            : base(fixture)
        {
        }
