...
{
    // Regression test for CSHARP-4466.
    public class AppendStageWithResultSerializerTests : LinqIntegrationTest<AppendStageWithResultSerializerTests.ClassFixture>
    {
        public AppendStageWithResultSerializerTests(ClassFixture fixture)
            : base(fixture)
        {
        }
