...
{
// Regression test for CSHARP-3435.
public class GroupJoinWithFirstProjectionStagesTests : LinqIntegrationTest<GroupJoinWithFirstProjectionStagesTests.ClassFixture>
{
    public GroupJoinWithFirstProjectionStagesTests(ClassFixture fixture)
        : base(fixture)
    {
    }
