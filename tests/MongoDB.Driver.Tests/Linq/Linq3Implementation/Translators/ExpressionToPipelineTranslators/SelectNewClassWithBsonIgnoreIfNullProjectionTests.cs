...
{
    // Regression test for CSHARP-1555.
    public class SelectNewClassWithBsonIgnoreIfNullProjectionTests : LinqIntegrationTest<SelectNewClassWithBsonIgnoreIfNullProjectionTests.ClassFixture>
    {
        public SelectNewClassWithBsonIgnoreIfNullProjectionTests(ClassFixture fixture)
            : base(fixture)
        {
        }
