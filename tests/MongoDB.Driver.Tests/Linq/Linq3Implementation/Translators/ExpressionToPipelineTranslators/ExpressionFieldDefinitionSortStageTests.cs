...
{
    // Regression test for CSHARP-4499.
    public class ExpressionFieldDefinitionSortStageTests : LinqIntegrationTest<ExpressionFieldDefinitionSortStageTests.ClassFixture>
    {
        public ExpressionFieldDefinitionSortStageTests(ClassFixture fixture)
            : base(fixture)
        {
        }
