...
{
    // Regression test for CSHARP-4562.
    public class SortByWithDictionaryIndexerTests : LinqIntegrationTest<SortByWithDictionaryIndexerTests.ClassFixture>
    {
        public SortByWithDictionaryIndexerTests(ClassFixture fixture)
            : base(fixture)
        {
        }
