...
// Regression test for CSHARP-5877.
public class GroupByWithFirstOverWrappedSourcePipelineTests : LinqIntegrationTest<GroupByWithFirstOverWrappedSourcePipelineTests.ClassFixture>
{
    public GroupByWithFirstOverWrappedSourcePipelineTests(ClassFixture fixture)
        : base(fixture)
    {
    }
