...
{
    // Regression test for CSHARP-5241.
    public class JoinWithVariousResultShapesPipelineTests : LinqIntegrationTest<JoinWithVariousResultShapesPipelineTests.ClassFixture>
    {
        public JoinWithVariousResultShapesPipelineTests(ClassFixture fixture)
            : base(fixture)
        {
        }
