...
{
    // Regression test for CSHARP-4493.
    public class AnyContainsToLowerFindFilterTests : LinqIntegrationTest<AnyContainsToLowerFindFilterTests.ClassFixture>
    {
        public AnyContainsToLowerFindFilterTests(ClassFixture fixture)
            : base(fixture)
        {
        }
