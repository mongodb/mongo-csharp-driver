...
{
    // Regression test for CSHARP-1906.
    public class ContainsToLowerAndStringInRegexFilterTests : LinqIntegrationTest<ContainsToLowerAndStringInRegexFilterTests.ClassFixture>
    {
        public ContainsToLowerAndStringInRegexFilterTests(ClassFixture fixture)
            : base(fixture)
        {
        }
