...
namespace MongoDB.Driver.Tests.Linq.Linq3Implementation.Translators.ExpressionToFilterTranslators.MethodTranslators
{
    ...
    public class StringContainsStartsWithEndsWithFilterTests : LinqIntegrationTest<StringContainsStartsWithEndsWithFilterTests.ClassFixture>
    {
        public StringContainsStartsWithEndsWithFilterTests(ClassFixture fixture) : base(fixture)
        {
        }
