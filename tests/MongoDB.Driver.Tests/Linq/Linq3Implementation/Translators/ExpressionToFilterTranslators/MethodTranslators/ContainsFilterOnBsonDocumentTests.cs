...
{
    // Regression test for CSHARP-2727.
    public class ContainsFilterOnBsonDocumentTests : LinqIntegrationTest<ContainsFilterOnBsonDocumentTests.ClassFixture>
    {
        public ContainsFilterOnBsonDocumentTests(ClassFixture fixture)
            : base(fixture)
        {
        }
