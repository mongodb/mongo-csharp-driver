...
{
    // Regression test for CSHARP-1754.
    public class AnyWithAllContainsToElemMatchAllFilterTests : LinqIntegrationTest<AnyWithAllContainsToElemMatchAllFilterTests.ClassFixture>
    {
        public AnyWithAllContainsToElemMatchAllFilterTests(ClassFixture fixture)
            : base(fixture)
        {
        }
