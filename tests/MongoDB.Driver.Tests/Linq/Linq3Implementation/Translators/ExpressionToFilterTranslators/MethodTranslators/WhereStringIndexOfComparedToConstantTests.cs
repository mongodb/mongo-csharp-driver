...
// Regression test for CSHARP-5654.
public class WhereStringIndexOfComparedToConstantTests : LinqIntegrationTest<WhereStringIndexOfComparedToConstantTests.ClassFixture>
{
    public WhereStringIndexOfComparedToConstantTests(ClassFixture fixture)
        : base(fixture)
    {
    }
