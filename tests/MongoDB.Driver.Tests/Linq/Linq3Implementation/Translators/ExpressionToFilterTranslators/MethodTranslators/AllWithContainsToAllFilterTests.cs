...
{
    // Regression test for CSHARP-4607.
    public class AllWithContainsToAllFilterTests : LinqIntegrationTest<AllWithContainsToAllFilterTests.ClassFixture>
    {
        public AllWithContainsToAllFilterTests(ClassFixture fixture)
            : base(fixture)
        {
        }
