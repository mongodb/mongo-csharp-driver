...
{
    // Regression test for CSHARP-3144.
    public class WhereSelectContainsAsFilterTests : LinqIntegrationTest<WhereSelectContainsAsFilterTests.ClassFixture>
    {
        public WhereSelectContainsAsFilterTests(ClassFixture fixture)
            : base(fixture)
        {
        }
