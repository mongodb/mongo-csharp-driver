...
{
    // Regression test for CSHARP-5427.
    public class WhereMqlExistsAndIsMissingTests : LinqIntegrationTest<WhereMqlExistsAndIsMissingTests.ClassFixture>
    {
        public WhereMqlExistsAndIsMissingTests(ClassFixture fixture)
            : base(fixture)
        {
        }
