...
// Regression test for CSHARP-5572.
public class WhereSubstringTrimAndNullableBoolTests : LinqIntegrationTest<WhereSubstringTrimAndNullableBoolTests.ClassFixture>
{
    public WhereSubstringTrimAndNullableBoolTests(ClassFixture fixture)
        : base(fixture)
    {
    }
