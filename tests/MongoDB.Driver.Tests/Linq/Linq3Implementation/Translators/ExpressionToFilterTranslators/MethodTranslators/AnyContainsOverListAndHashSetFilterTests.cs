...
{
    // Regression test for CSHARP-4702.
    public class AnyContainsOverListAndHashSetFilterTests : LinqIntegrationTest<AnyContainsOverListAndHashSetFilterTests.ClassFixture>
    {
        public AnyContainsOverListAndHashSetFilterTests(ClassFixture fixture)
            : base(fixture)
        {
        }
