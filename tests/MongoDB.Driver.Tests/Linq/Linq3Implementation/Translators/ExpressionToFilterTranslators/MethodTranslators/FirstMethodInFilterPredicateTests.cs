...
{
    // Regression test for CSHARP-4328.
    public class FirstMethodInFilterPredicateTests : LinqIntegrationTest<FirstMethodInFilterPredicateTests.ClassFixture>
    {
        public FirstMethodInFilterPredicateTests(ClassFixture fixture)
            : base(fixture)
        {
        }
