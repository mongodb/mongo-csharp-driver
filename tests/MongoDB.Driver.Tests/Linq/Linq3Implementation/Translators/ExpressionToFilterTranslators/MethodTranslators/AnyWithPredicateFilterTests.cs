...
{
    // Regression test for CSHARP-2348.
    public class AnyWithPredicateFilterTests : LinqIntegrationTest<AnyWithPredicateFilterTests.ClassFixture>
    {
        public AnyWithPredicateFilterTests(ClassFixture fixture)
            : base(fixture)
        {
        }
