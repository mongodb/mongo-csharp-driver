...
{
    // Regression test for CSHARP-4776.
    public class CountLengthLongCountToSizeFilterTests : LinqIntegrationTest<CountLengthLongCountToSizeFilterTests.ClassFixture>
    {
        public CountLengthLongCountToSizeFilterTests(ClassFixture fixture)
            : base(fixture)
        {
        }
