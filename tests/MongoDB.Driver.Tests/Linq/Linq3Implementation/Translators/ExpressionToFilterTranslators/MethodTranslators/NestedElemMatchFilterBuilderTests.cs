...
{
    // Regression test for CSHARP-1585.
    public class NestedElemMatchFilterBuilderTests : LinqIntegrationTest<NestedElemMatchFilterBuilderTests.ClassFixture>
    {
        public NestedElemMatchFilterBuilderTests(ClassFixture fixture)
            : base(fixture)
        {
        }
