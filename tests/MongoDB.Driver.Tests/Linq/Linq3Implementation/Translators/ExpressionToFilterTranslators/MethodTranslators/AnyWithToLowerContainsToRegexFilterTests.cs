...
{
    // Regression test for CSHARP-4500.
    public class AnyWithToLowerContainsToRegexFilterTests : LinqIntegrationTest<AnyWithToLowerContainsToRegexFilterTests.ClassFixture>
    {
        public AnyWithToLowerContainsToRegexFilterTests(ClassFixture fixture)
            : base(fixture)
        {
        }
