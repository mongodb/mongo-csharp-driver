...
namespace MongoDB.Driver.Tests.Linq.Linq3Implementation.Translators.ExpressionToFilterTranslators.MethodTranslators
{
    ...
    // Regression test for CSHARP-3283.
    public class WhereStringIndexOfAndToLowerStartsWithFilterTests
    {
        [Fact]
        ...
        private BsonDocument[] Translate<T>(IQueryable<T> queryable)
        {
            ...
            return executableQuery.Pipeline.Ast.Render().AsBsonArray.Cast<BsonDocument>().ToArray();
        }
