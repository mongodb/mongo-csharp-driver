...
{
    // Regression test for CSHARP-3234.
    public class WhereArrayContainsWithBooleanComparisonTests : LinqIntegrationTest<WhereArrayContainsWithBooleanComparisonTests.ClassFixture>
    {
        public WhereArrayContainsWithBooleanComparisonTests(ClassFixture fixture)
            : base(fixture)
        {
        }
