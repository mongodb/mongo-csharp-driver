...
{
    // Regression test for CSHARP-4066.
    public class StringIdWithObjectIdRepresentationFilterTests : IntegrationTest<StringIdWithObjectIdRepresentationFilterTests.ClassFixture>
    {
        private const string IdValue = "0102030405060708090a0b0c";

        public StringIdWithObjectIdRepresentationFilterTests(ClassFixture fixture)
            : base(fixture)
        {
        }
