...
{
    // Regression test for CSHARP-4572.
    [Collection(RegisterObjectSerializerFixture.CollectionName)]
    public class DowncastInFilterTests : LinqIntegrationTest<DowncastInFilterTests.ClassFixture>
    {
        public DowncastInFilterTests(ClassFixture fixture)
            : base(fixture)
        {
        }
