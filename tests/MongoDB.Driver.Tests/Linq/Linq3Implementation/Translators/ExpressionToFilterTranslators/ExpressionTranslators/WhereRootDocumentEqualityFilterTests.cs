...
{
    // Regression test for CSHARP-4244.
    public class WhereRootDocumentEqualityFilterTests : LinqIntegrationTest<WhereRootDocumentEqualityFilterTests.ClassFixture>
    {
        public WhereRootDocumentEqualityFilterTests(ClassFixture fixture)
