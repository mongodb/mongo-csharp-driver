...
{
    // Regression test for CSHARP-4401.
    public class WhereWithEnumComparisonOperatorsFilterTests : LinqIntegrationTest<WhereWithEnumComparisonOperatorsFilterTests.ClassFixture>
    {
        ...
        public WhereWithEnumComparisonOperatorsFilterTests(ClassFixture fixture)
            : base(fixture)
        {
        }
        ...
        static WhereWithEnumComparisonOperatorsFilterTests()
        {
