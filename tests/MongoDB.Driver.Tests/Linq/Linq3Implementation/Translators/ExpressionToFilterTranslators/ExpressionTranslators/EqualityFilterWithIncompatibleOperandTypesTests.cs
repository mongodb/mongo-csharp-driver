...
{
    // Regression test for CSHARP-4517.
    public class EqualityFilterWithIncompatibleOperandTypesTests : LinqIntegrationTest<EqualityFilterWithIncompatibleOperandTypesTests.ClassFixture>
    {
        public EqualityFilterWithIncompatibleOperandTypesTests(ClassFixture fixture)
            : base(fixture)
        {
        }
