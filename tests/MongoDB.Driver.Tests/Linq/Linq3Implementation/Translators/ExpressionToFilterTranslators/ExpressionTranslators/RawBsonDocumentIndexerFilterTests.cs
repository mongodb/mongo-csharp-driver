...
{
    // Regression test for CSHARP-2195.
    public class RawBsonDocumentIndexerFilterTests : LinqIntegrationTest<RawBsonDocumentIndexerFilterTests.ClassFixture>
    {
        public RawBsonDocumentIndexerFilterTests(ClassFixture fixture)
            : base(fixture)
        {
        }
