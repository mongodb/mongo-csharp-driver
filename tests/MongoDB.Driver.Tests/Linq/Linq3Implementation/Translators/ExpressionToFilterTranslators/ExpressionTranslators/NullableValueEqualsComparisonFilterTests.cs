...
{
    // Regression test for CSHARP-4566.
    public class NullableValueEqualsComparisonFilterTests : LinqIntegrationTest<NullableValueEqualsComparisonFilterTests.ClassFixture>
    {
        public NullableValueEqualsComparisonFilterTests(ClassFixture fixture)
        : base(fixture)
    {
    }
