...
{
    // Regression test for CSHARP-4316.
    public class NullableValueAndHasValuePropertyAccessTests : LinqIntegrationTest<NullableValueAndHasValuePropertyAccessTests.ClassFixture>
    {
        public NullableValueAndHasValuePropertyAccessTests(ClassFixture fixture) : base(fixture)
        {
        }
