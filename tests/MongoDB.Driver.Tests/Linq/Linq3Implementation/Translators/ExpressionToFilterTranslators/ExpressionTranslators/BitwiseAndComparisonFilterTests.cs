...
{
    // Regression test for CSHARP-2003.
    public class BitwiseAndComparisonFilterTests : LinqIntegrationTest<BitwiseAndComparisonFilterTests.ClassFixture>
    {
        public BitwiseAndComparisonFilterTests(ClassFixture fixture)
            : base(fixture)
        {
        }
