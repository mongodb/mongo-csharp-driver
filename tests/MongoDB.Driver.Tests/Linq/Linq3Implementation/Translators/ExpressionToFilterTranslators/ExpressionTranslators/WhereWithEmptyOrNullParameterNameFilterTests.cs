...
{
    // Regression test for CSHARP-4521.
    public class WhereWithEmptyOrNullParameterNameFilterTests : LinqIntegrationTest<WhereWithEmptyOrNullParameterNameFilterTests.ClassFixture>
    {
        public WhereWithEmptyOrNullParameterNameFilterTests(ClassFixture fixture)
            : base(fixture)
        {
        }
