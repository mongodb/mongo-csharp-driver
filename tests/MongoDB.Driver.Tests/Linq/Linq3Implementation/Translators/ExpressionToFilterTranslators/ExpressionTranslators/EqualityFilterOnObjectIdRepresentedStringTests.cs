...
{
    // Regression test for CSHARP-4370.
    public class EqualityFilterOnObjectIdRepresentedStringTests : LinqIntegrationTest<EqualityFilterOnObjectIdRepresentedStringTests.ClassFixture>
    {
        public EqualityFilterOnObjectIdRepresentedStringTests(ClassFixture fixture)
            : base(fixture)
        {
        }
