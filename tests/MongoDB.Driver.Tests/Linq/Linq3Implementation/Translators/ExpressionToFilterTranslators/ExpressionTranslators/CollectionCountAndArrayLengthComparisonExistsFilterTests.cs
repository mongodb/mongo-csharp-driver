...
{
    // Regression test for CSHARP-4861.
    public class CollectionCountAndArrayLengthComparisonExistsFilterTests : LinqIntegrationTest<CollectionCountAndArrayLengthComparisonExistsFilterTests.ClassFixture>
    {
        public CollectionCountAndArrayLengthComparisonExistsFilterTests(ClassFixture fixture)
            : base(fixture)
        {
        }
