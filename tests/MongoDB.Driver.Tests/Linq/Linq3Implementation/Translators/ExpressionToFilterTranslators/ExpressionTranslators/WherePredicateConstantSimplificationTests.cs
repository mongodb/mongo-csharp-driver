...
{
    // Regression test for CSHARP-3140.
    public class WherePredicateConstantSimplificationTests : LinqIntegrationTest<WherePredicateConstantSimplificationTests.ClassFixture>
    {
        public WherePredicateConstantSimplificationTests(ClassFixture fixture)
            : base(fixture)
        {
        }
