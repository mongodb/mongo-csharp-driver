...
{
    // Regression test for CSHARP-4332.
    public class EqualityFilterWithGuidAndCustomStructTests : Linq3IntegrationTest
    {
        private static readonly (Expression<Func<Document, bool>> Predicate, string ExpectedFilter)[] __testCases;

        static EqualityFilterWithGuidAndCustomStructTests()
        {
