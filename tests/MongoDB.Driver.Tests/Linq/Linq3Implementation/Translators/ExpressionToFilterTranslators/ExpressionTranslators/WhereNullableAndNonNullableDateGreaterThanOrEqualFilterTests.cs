...
{
    // Regression test for CSHARP-4803.
    public class WhereNullableAndNonNullableDateGreaterThanOrEqualFilterTests : LinqIntegrationTest<WhereNullableAndNonNullableDateGreaterThanOrEqualFilterTests.ClassFixture>
    {
        public WhereNullableAndNonNullableDateGreaterThanOrEqualFilterTests(ClassFixture fixture)
            : base(fixture)
        {
        }
