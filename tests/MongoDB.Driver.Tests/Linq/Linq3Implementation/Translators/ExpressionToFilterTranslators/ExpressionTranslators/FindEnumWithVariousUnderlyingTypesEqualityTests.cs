...
// Regression test for CSHARP-5564.
public class FindEnumWithVariousUnderlyingTypesEqualityTests : LinqIntegrationTest<FindEnumWithVariousUnderlyingTypesEqualityTests.ClassFixture>
{
    public FindEnumWithVariousUnderlyingTypesEqualityTests(ClassFixture fixture)
        : base(fixture)
    {
    }
