...
{
    // Regression test for CSHARP-4116.
    public class ConstantBooleanWhereFilterOptimizationTests : LinqIntegrationTest<ConstantBooleanWhereFilterOptimizationTests.ClassFixture>
    {
        public ConstantBooleanWhereFilterOptimizationTests(ClassFixture fixture)
            : base(fixture)
        {
        }
