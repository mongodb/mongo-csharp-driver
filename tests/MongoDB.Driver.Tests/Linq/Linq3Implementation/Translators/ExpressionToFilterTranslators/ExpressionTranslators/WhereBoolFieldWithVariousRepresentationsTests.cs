...
{
    // Regression test for CSHARP-5067.
    public class WhereBoolFieldWithVariousRepresentationsTests : LinqIntegrationTest<WhereBoolFieldWithVariousRepresentationsTests.ClassFixture>
    {
        public WhereBoolFieldWithVariousRepresentationsTests(ClassFixture fixture)
            : base(fixture)
        {
        }
