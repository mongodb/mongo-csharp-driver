...
namespace MongoDB.Driver.Tests.Search
{
    ...
    public class AtlasSearchTests : LoggableTestClass
    {
        ...
        [Fact]
        public void VectorSearch_Limit()
        {
            var expectedTitles = new[]
            {
                "Willy Wonka & the Chocolate Factory",
        ...
        [Fact]
        public void VectorSearch_Filter()
        {
            var expectedTitles = new[]
            {
                "Time Bandits",
        ...
        [Fact]
        public void VectorSearch_ProjectAndScore()
        {
            var expectedTitles = new[]
            {
                "Time Bandits",
        ...
        [Fact]
        public void VectorSearch_ProjectAndCount()
        {
            var expectedTitles = new[]
            {
                "Time Bandits",
            ...
            var results = GetEmbeddedMoviesCollection<EmbeddedMovie>()
                .Aggregate()
                .Search(vectorSearch, indexName: SearchWithVectorIndexName, count: new() { Type = SearchCountType.Total })
                .Project<EmbeddedMovie>(Builders<EmbeddedMovie>.Projection
                    .Include(m => m.Title)
