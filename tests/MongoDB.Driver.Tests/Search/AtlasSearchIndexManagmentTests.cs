...
namespace MongoDB.Driver.Tests.Search
{
    ...
    public class AtlasSearchIndexManagementTests : LoggableTestClass
    {
            ...
            [Values(false, true)] bool async)
        {
            ...
            var indexModel = new CreateAtlasVectorIndexModel<EntityWithVector>(
            ...
            var createdName = async
                ...
                : _collection.SearchIndexes.CreateOne(indexModel);
            ...
            [Values(false, true)] bool async)
        {
            ...
            var indexModel = new CreateAtlasVectorIndexModel("vectors", indexName, VectorSimilarity.Euclidean, dimensions: 4);
            ...
            [Values(false, true)] bool async)
        {
            ...
            var indexModel = new CreateAtlasVectorIndexModel(
                "vectors",
                indexName,
