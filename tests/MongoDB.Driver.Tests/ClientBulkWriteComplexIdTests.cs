...
// Regression test for CSHARP-5697.
public class ClientBulkWriteComplexIdTests : IntegrationTest<ClientBulkWriteComplexIdTests.ClassFixture>
{
    public ClientBulkWriteComplexIdTests(ClassFixture fixture)
