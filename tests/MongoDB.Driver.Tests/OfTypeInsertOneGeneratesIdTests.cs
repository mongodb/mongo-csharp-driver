...
{
    // Regression test for CSHARP-2622.
    [Trait("Category", "Integration")]
    public class OfTypeInsertOneGeneratesIdTests
    {
        // public methods
        [Fact]
        public void InsertOne_to_oftype_collection_should_generate_id()
        {
            var collectionNamespace = CoreTestConfiguration.GetCollectionNamespaceForTestClass(typeof(OfTypeInsertOneGeneratesIdTests));
