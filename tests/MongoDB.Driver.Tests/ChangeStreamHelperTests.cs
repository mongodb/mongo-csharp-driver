...
namespace MongoDB.Driver.Tests
{
    public class ChangeStreamHelperTests
    {
        ...
        public void CreateChangeStreamOperation_for_client_returns_expected_result()
        {
            ...
            var result = ChangeStreamHelper.CreateChangeStreamOperation(pipeline, options, readConcern, messageEncoderSettings, retryRequested: true, maxAdaptiveRetries: 2, enableOverloadRetargeting: false, translationOptions: null, serializationDomain: BsonSerializationDomain.Default);
        ...
        public void CreateChangeStreamOperation_for_database_returns_expected_result()
        {
            ...
            var result = ChangeStreamHelper.CreateChangeStreamOperation(mockDatabase.Object, pipeline, options, readConcern, messageEncoderSettings, retryRequested: true, maxAdaptiveRetries: 2, enableOverloadRetargeting: false, translationOptions: null, serializationDomain: BsonSerializationDomain.Default);
        ...
        public void CreateChangeStreamOperation_for_collection_returns_expected_result()
        {
            ...
            var result = ChangeStreamHelper.CreateChangeStreamOperation(mockCollection.Object, pipeline, documentSerializer, options, readConcern, messageEncoderSettings, retryRequested: true, maxAdaptiveRetries: 2, enableOverloadRetargeting: false, translationOptions: null, serializationDomain: BsonSerializationDomain.Default);
