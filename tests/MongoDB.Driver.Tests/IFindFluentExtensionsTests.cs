...
namespace MongoDB.Driver.Tests
{
    public class IFindFluentExtensionsTests : Linq3IntegrationTest
    {
        ...
        {
            Assert.Equal(expectedProjection, subject.Options.Projection.Render(new(BsonSerializer.SerializerRegistry.GetSerializer<Person>(), BsonSerializer.SerializerRegistry, linqProvider, isAggregateMode: false)).Document);
        }
