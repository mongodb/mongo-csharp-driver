...
// Regression test for CSHARP-5757.
public class OfTypeDiscriminatorConventionTests : LinqIntegrationTest<OfTypeDiscriminatorConventionTests.ClassFixture>
{
    static OfTypeDiscriminatorConventionTests()
    {
    ...
    public OfTypeDiscriminatorConventionTests(ClassFixture fixture)
        : base(fixture)
    {
    }
