...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        public void IsCompatibleWithDriver_should_return_expected_result(int[] wireRanges, bool expectedResult)
        {
            ...
            var subject = ClusterDescription.CreateInitial(clusterId, directConnection: false);
        ...
        public void LogicalSessionTimeout_should_return_expected_result_with_0_servers()
        {
            ...
            var subject = new ClusterDescription(clusterId, false, null, type, servers);
        ...
        public void LogicalSessionTimeout_should_return_expected_result_with_1_server(int? timeout1, int? expectedResultMinutes)
        {
            ...
            var subject = new ClusterDescription(clusterId, directConnection: false, dnsMonitorException: null, type, servers);
        ...
        public void State_should_be_connected_if_any_server_is_connected()
        {
            ...
            var subject = new ClusterDescription(new ClusterId(1), directConnection: false, null, ClusterType.Standalone, [__serverDescription1, connected]);
        ...
        public void ToString_should_return_string_representation_when_dnsMonitorException_is_not_null()
        {
            ...
            var subject = new ClusterDescription(new ClusterId(1), false, dnsMonitorException, ClusterType.Standalone, [__serverDescription1]);
            var expected = $"{{ ClusterId : \"1\", Type : \"Standalone\", State : \"Disconnected\", Servers : [{__serverDescription1}], DnsMonitorException : \"{dnsMonitorException}\" }}";
            subject.ToString().Should().Be(expected);
        }
        ...
        private ClusterDescription CreateSubject(Exception dnsMonitorException) =>
            new(new ClusterId(1),
                ...
                dnsMonitorException,
                ClusterType.ReplicaSet,
                [__serverDescription1, __serverDescription2]);
        ...
        private ClusterDescription CreateSubject(string notEqualField = null)
        {
            ...
            if (notEqualField != null)
            {
                switch (notEqualField)
                {
                    ...
                    case "Servers": servers = [__serverDescription1]; break;
                    default: throw new ArgumentException($"Unknown field name: \"{notEqualField}\".", nameof(notEqualField));
                }
            }

            return new(clusterId, directConnection, dnsMonitorException, type, servers);
        }
    }
}
