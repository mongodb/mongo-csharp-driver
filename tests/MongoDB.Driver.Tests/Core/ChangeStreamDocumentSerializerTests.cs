...
namespace MongoDB.Driver
{
    public class ChangeStreamDocumentSerializerTests
    {
        ...
        {
            var x = new ChangeStreamDocumentSerializer<Document>(new DocumentSerializer1());
            var y = new DerivedFromChangeStreamDocumentSerializer<Document>(new DocumentSerializer1());
        ...
        {
            var x = new ChangeStreamDocumentSerializer<Document>(new DocumentSerializer1());
            var y = new ChangeStreamDocumentSerializer<Document>(new DocumentSerializer1());
        ...
        {
            var x = new ChangeStreamDocumentSerializer<Document>(new DocumentSerializer1());
            var y = new ChangeStreamDocumentSerializer<Document>(new DocumentSerializer2());
        ...
        public class DocumentSerializer1 : ClassSerializerBase<Document> { }

        public class DocumentSerializer2 : ClassSerializerBase<Document> { }
