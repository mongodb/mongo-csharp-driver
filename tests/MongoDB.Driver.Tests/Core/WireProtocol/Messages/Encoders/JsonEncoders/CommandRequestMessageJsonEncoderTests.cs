...
{
    public class CommandRequestMessageJsonEncoderTests
    {
        [Fact]
        ...
        private CommandRequestMessageJsonEncoder CreateSubject(string json)
        {
    ...
    public static class CommandRequestMessageJsonEncoderReflector
    {
        ...
        {
            var fieldInfo = typeof(CommandRequestMessageJsonEncoder).GetField("_wrappedEncoder", BindingFlags.NonPublic | BindingFlags.Instance);
