...
{
    public class CommandRequestMessageBinaryEncoderTests
    {
        [Fact]
        public void constructor_should_initialize_instance()
        {
            ...
            var result = new CommandRequestMessageBinaryEncoder(wrappedEncoder);
        ...
        public void ReadMessage_should_delegate_to_wrapped_encoder()
        {
            ...
            var resultMessage = result.Should().BeOfType<CommandRequestMessage>().Subject;
        ...
        private CommandRequestMessageBinaryEncoder CreateSubject(Stream stream)
        {
            var encoderSettings = new MessageEncoderSettings();
            var wrappedEncoder = new CommandMessageBinaryEncoder(stream, encoderSettings);
    ...
    internal static class CommandRequestMessageBinaryEncoderReflector
    {
        public static CommandMessageBinaryEncoder _wrappedEncoder(this CommandRequestMessageBinaryEncoder obj)
        {
            var fieldInfo = typeof(CommandRequestMessageBinaryEncoder).GetField("_wrappedEncoder", BindingFlags.NonPublic | BindingFlags.Instance);
