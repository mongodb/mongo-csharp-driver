...
{
    public class CommandResponseMessageTests
    {
        [Fact]
        public void constructor_should_initialize_instance()
        {
            ...
            var result = new CommandResponseMessage(wrappedMessage);

            result.WrappedMessage.Should().BeSameAs(wrappedMessage);
            result.RequestId.Should().Be(wrappedMessage.RequestId);
            result.ResponseTo.Should().Be(wrappedMessage.ResponseTo);
        }
        ...
        public void GetEncoder_should_return_expected_result()
        {
            ...
            result.Should().BeOfType<CommandResponseMessageBinaryEncoder>();
        }

        // private methods
        private CommandResponseMessage CreateSubject(
