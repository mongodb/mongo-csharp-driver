...
namespace MongoDB.Driver.Core.Operations
{
    public class DropCollectionOperationTests : OperationTestBase
    {
        ...
        public void CreateEncryptedDropCollectionOperationIfConfigured_should_return_expected_result_when_EncryptedFields_is_set(string[] escCollectionStrElement, string[] ecocCollectionStrElement)
        {
