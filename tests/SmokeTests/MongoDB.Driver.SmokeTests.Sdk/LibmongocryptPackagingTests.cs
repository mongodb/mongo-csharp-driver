...
{
    public class LibmongocryptPackagingTests
    {
        private const string LocalMasterKey = "Mng0NCt4ZHVUYUJCa1kxNkVyNUR1QURhZ2h2UzR2d2RrZzh0cFBwM3R6NmdWMDFBMUN3YkQ5aXRRMkhGRGdQV09wOGVNYUMxT2k3NjZKelhaQmRCZGJkTXVyZG9uSjFk";

        private readonly ITestOutputHelper _output;

        public LibmongocryptPackagingTests(ITestOutputHelper output)
        {
            InfrastructureUtilities.ValidateMongoDBPackageVersion("libmongocrypt");
        ...
        public void Explicit_encryption_with_Libmongocrypt_package_works()
        {
            ...
            var keyVaultClient = new MongoClient(uri);
