...
namespace MongoDB.Bson.Serialization.Serializers
{
    ...
    public class BsonValueSerializer1 : IBsonSerializer<BsonValue>
    {
        public Type ValueType => typeof(BsonValue);

        public BsonValue Deserialize(BsonDeserializationContext context, BsonDeserializationArgs args) => throw new NotImplementedException();
        public void Serialize(BsonSerializationContext context, BsonSerializationArgs args, BsonValue value) => throw new NotImplementedException();
    ...
    public class BsonValueSerializer2 : IBsonSerializer<BsonValue>
    {
        public Type ValueType => typeof(BsonValue);
