...
namespace MongoDB.Bson.Tests.Serialization.Serializers
{
    public class ImmutableListSerializerTests
    {
        ...
        public void Deserialize_should_have_expected_result()
        {
            ...
            var subject = new ImmutableListSerializer<int>(BsonSerializationDomain.Default);
            ...
            var expectedResult = ImmutableList.Create(1, 2, 3, 4);
        ...
        {
            var x = new ImmutableListSerializer<int>(BsonSerializationDomain.Default);
        ...
        {
            var subject = new ImmutableListSerializer<int>(BsonSerializationDomain.Default);
            var value = ImmutableList.Create(1, 2, 3, 4);
        ...
        {
            var serializer = BsonSerializer.LookupSerializer(typeof(ImmutableList<int>));

            serializer.Should().Be(new ImmutableListSerializer<int>(BsonSerializationDomain.Default));
        }
    }
}
#endif