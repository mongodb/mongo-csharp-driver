...
{
    // Regression test for CSHARP-4475.
    public class ObjectSerializerAllowedTypesTests
    {
        static ObjectSerializerAllowedTypesTests()
        {
        ...
        {
            var json = "{ Object : { _t : 'MongoDB.Bson.Tests.Serialization.Serializers.ObjectSerializerAllowedTypesTests+Allowed, MongoDB.Bson.Tests', X : 1  } }";
