...
namespace MongoDB.Bson.Tests.Serialization.Serializers
{
    public class ImmutableArraySerializerTests
    {
        ...
        public void Deserialize_should_have_expected_result()
        {
            ...
            var subject = new ImmutableArraySerializer<int>(BsonSerializationDomain.Default);
            ...
            var expectedResult = ImmutableArray.Create(1, 2, 3, 4);
        ...
        {
            var x = new ImmutableArraySerializer<int>(BsonSerializationDomain.Default);
        ...
        {
            var serializer = BsonSerializer.LookupSerializer(typeof(ImmutableArray<int>));

            serializer.Should().Be(new ImmutableArraySerializer<int>(BsonSerializationDomain.Default));
        }
    }
}
#endif