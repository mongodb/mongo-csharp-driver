...
namespace MongoDB.Bson.Tests.Serialization.Serializers
{
    public class EnumerableInterfaceImplementerSerializerBaseTests
    {
        ...
        {
            var x = new ConcreteEnumerableInterfaceImplementerSerializerBase<List<int>>(__itemSerializer1);
        ...
        {
            var x = new ConcreteEnumerableInterfaceImplementerSerializerBase<List<int>>(__itemSerializer1);
            var y = new ConcreteEnumerableInterfaceImplementerSerializerBase<List<int>>(__itemSerializer1);
        ...
        {
            var x = new ConcreteEnumerableInterfaceImplementerSerializerBase<List<int>>(__itemSerializer1);
            var y = new ConcreteEnumerableInterfaceImplementerSerializerBase<List<int>>(__itemSerializer2);
    ...
    public class EnumerableInterfaceImplementerSerializerBaseGenericTests
    {
        ...
        public void Equals_derived_should_return_false()
        {
            var x = new ConcreteEnumerableInterfaceImplementerSerializerBase<List<int>, int>(__itemSerializer1);
        ...
        {
            var x = new ConcreteEnumerableInterfaceImplementerSerializerBase<List<int>, int>(__itemSerializer1);
            var y = new ConcreteEnumerableInterfaceImplementerSerializerBase<List<int>, int>(__itemSerializer1);
        ...
        {
            var x = new ConcreteEnumerableInterfaceImplementerSerializerBase<List<int>, int>(__itemSerializer1);
            var y = new ConcreteEnumerableInterfaceImplementerSerializerBase<List<int>, int>(__itemSerializer2);
