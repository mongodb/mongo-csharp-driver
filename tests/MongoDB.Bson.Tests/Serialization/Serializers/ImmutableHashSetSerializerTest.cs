...
namespace MongoDB.Bson.Tests.Serialization.Serializers
{
    public class ImmutableHashSetSerializerTests
    {
        ...
        public void Deserialize_should_have_expected_result()
        {
            ...
            var subject = new ImmutableHashSetSerializer<int>(BsonSerializationDomain.Default);
        ...
        {
            var x = new ImmutableHashSetSerializer<int>(BsonSerializationDomain.Default);
        ...
        public void Serializer_should_be_registered()
        {
            ...
            serializer.Should().Be(new ImmutableHashSetSerializer<int>(BsonSerializationDomain.Default));
        }
    }
}
#endif