...
namespace MongoDB.Bson.Tests.Serialization.Serializers
{
    public class ImmutableQueueSerializerTests
    {
        ...
        public void Deserialize_should_have_expected_result()
        {
            ...
            var subject = new ImmutableQueueSerializer<int>(BsonSerializationDomain.Default);
            ...
            var expectedResult = ImmutableQueue.Create(1, 2, 3, 4);
        ...
        {
            var x = new ImmutableQueueSerializer<int>(BsonSerializationDomain.Default);
        ...
        {
            var subject = new ImmutableQueueSerializer<int>(BsonSerializationDomain.Default);
            var value = ImmutableQueue.Create(1, 2, 3, 4);
        ...
        {
            var serializer = BsonSerializer.LookupSerializer(typeof(ImmutableQueue<int>));

            serializer.Should().Be(new ImmutableQueueSerializer<int>(BsonSerializationDomain.Default));
        }
    }
}
#endif