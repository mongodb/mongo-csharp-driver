...
namespace MongoDB.Bson.Tests.Serialization.Serializers
{
    public class DoubleSerializerTests
    {
        ...
        public void Equals_derived_should_return_false()
        {
            ...
            var y = new DerivedFromDoubleSerializer(BsonType.Double);
        ...
        {
            var x = new DoubleSerializer(BsonType.Double);
            var y = new DoubleSerializer(BsonType.Double);
        ...
        {
            public DerivedFromDoubleSerializer(BsonType representation)
                : base(representation)
            {
            }
        }
