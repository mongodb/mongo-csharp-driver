...
namespace MongoDB.Bson.Tests.Serialization.Serializers
{
    public class QueueSerializerTests
    {
        ...
        public void Equals_with_not_equal_field_should_return_false()
        {
            ...
            var x = new QueueSerializer(itemSerializer1);
            var y = new QueueSerializer(itemSerializer2);
    ...
    public class QueueSerializerGenericTests
    {
        ...
        public void Equals_with_not_equal_field_should_return_false()
        {
            var itemSerializer1 = new Int32Serializer(BsonType.Int32);
            var itemSerializer2 = new Int32Serializer(BsonType.String);
            var x = new QueueSerializer<int>(itemSerializer1);
            var y = new QueueSerializer<int>(itemSerializer2);
