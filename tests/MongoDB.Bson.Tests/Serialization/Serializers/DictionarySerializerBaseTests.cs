...
namespace MongoDB.Bson.Tests.Serialization.Serializers
{
    public class DictionarySerializerBaseTests
    {
        ...
        {
            var x = new ConcreteDictionarySerializerBase<Hashtable>();
        ...
        {
            var x = new ConcreteDictionarySerializerBase<Hashtable>();
            var y = new ConcreteDictionarySerializerBase<Hashtable>();
        ...
        public void Equals_with_not_equal_field_should_return_false(string notEqualFieldName)
        {
            ...
            var x = new ConcreteDictionarySerializerBase<Hashtable>(DictionaryRepresentation.Document, objectSerializer1, objectSerializer1);
    ...
    public class DictionarySerializerBaseGenericTests
    {
        ...
        public void Equals_derived_should_return_false()
        {
            var x = new ConcreteDictionarySerializerBase<Dictionary<int, int>, int, int>();
        ...
        {
            var x = new ConcreteDictionarySerializerBase<Dictionary<int, int>, int, int>();
            var y = new ConcreteDictionarySerializerBase<Dictionary<int, int>, int, int>();
        ...
        public void Equals_with_not_equal_field_should_return_false(string notEqualFieldName)
        {
            ...
            var x = new ConcreteDictionarySerializerBase<Dictionary<int, int>, int, int>(DictionaryRepresentation.ArrayOfArrays, int32Serializer1, int32Serializer1);
            var y = notEqualFieldName switch
            {
                "dictionaryRepresentation" => new ConcreteDictionarySerializerBase<Dictionary<int, int>, int, int>(DictionaryRepresentation.ArrayOfDocuments, int32Serializer1, int32Serializer1),
                "keySerializer" => new ConcreteDictionarySerializerBase<Dictionary<int, int>, int, int>(DictionaryRepresentation.Document, int32Serializer2, int32Serializer1),
                "valueSerializer" => new ConcreteDictionarySerializerBase<Dictionary<int, int>, int, int>(DictionaryRepresentation.Document, int32Serializer1, int32Serializer2),
                _ => throw new Exception()
            };
