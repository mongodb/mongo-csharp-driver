...
namespace MongoDB.Bson.Tests.Serialization.Serializers
{
    public class EnumerableSerializerBaseTests
    {
        ...
        static EnumerableSerializerBaseTests()
        {
        ...
        {
            var x = new ConcreteEnumerableSerializerBase<List<int>>(__itemSerializer1);
        ...
        {
            var x = new ConcreteEnumerableSerializerBase<List<int>>(__itemSerializer1);
            var y = new ConcreteEnumerableSerializerBase<List<int>>(__itemSerializer1);
        ...
        {
            var x = new ConcreteEnumerableSerializerBase<List<int>>(__itemSerializer1);
            var y = new ConcreteEnumerableSerializerBase<List<int>>(__itemSerializer2);
    ...
    public class EnumerableSerializerBaseGenericTests
    {
        ...
        static EnumerableSerializerBaseGenericTests()
        {
            __itemSerializer1 = new Int32Serializer(BsonType.Int32);
            __itemSerializer2 = new Int32Serializer(BsonType.String);
        }
        ...
        public void Equals_derived_should_return_false()
        {
            var x = new ConcreteEnumerableSerializerBase<List<int>, int>(__itemSerializer1);
        ...
        {
            var x = new ConcreteEnumerableSerializerBase<List<int>, int>(__itemSerializer1);
            var y = new ConcreteEnumerableSerializerBase<List<int>, int>(__itemSerializer1);
        ...
        {
            var x = new ConcreteEnumerableSerializerBase<List<int>, int>(__itemSerializer1);
            var y = new ConcreteEnumerableSerializerBase<List<int>, int>(__itemSerializer2);
