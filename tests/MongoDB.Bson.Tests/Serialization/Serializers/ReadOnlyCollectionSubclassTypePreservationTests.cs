...
{
    // Regression test for CSHARP-515.
    [Collection(RegisterObjectSerializerFixture.CollectionName)]
    public class ReadOnlyCollectionSubclassTypePreservationTests
    {
        public class C
        {
        ...
        private string _jsonTemplate = ("{ '_id' : 1, 'R' : #V, 'S' : #V, 'RS' : { '_t' : 'S<Int32>', '_v' : #V }, 'OR' : { '_t' : 'System.Collections.ObjectModel.ReadOnlyCollection`1[System.Int32]', '_v' : #V }, 'OS' : { '_t' : 'MongoDB.Bson.Tests.Serialization.Serializers.ReadOnlyCollectionSubclassTypePreservationTests+S`1[System.Int32], " + __discriminatorAssemblyName + "', '_v' : #V } }").Replace("'", "\"");
