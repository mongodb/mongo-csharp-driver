...
{
    // Regression test for CSHARP-783.
#if WINDOWS
    [Collection(RegisterObjectSerializerFixture.CollectionName)]
    public class SetInterfaceDiscriminatedSerializationTests
    {
        // nested types
        private class C
        {
    ...
    [Collection(RegisterObjectSerializerFixture.CollectionName)]
    public class SetInterfaceImpliedHashSetImplementationTests
    {
        // nested types
        private class C
        {
    ...
    [Collection(RegisterObjectSerializerFixture.CollectionName)]
    public class SetInterfaceImpliedSortedSetImplementationTests
    {
        // nested types
        private class C
        {
