...
namespace MongoDB.Bson.Tests.Serialization.Serializers
{
    public class IEnumerableDeserializingAsCollectionSerializerTests
    {
        ...
        {
            var x = new IEnumerableDeserializingAsCollectionSerializer<IEnumerable<int>, int, List<int>>();
            var y = new IEnumerableDeserializingAsCollectionSerializer<IEnumerable<int>, int, List<int>>();
        ...
        public void Equals_with_not_equal_field_should_return_false()
        {
            ...
            var x = new IEnumerableDeserializingAsCollectionSerializer<IEnumerable<int>, int, List<int>>(int32Serializer1);
            var y = new IEnumerableDeserializingAsCollectionSerializer<IEnumerable<int>, int, List<int>>(int32Serializer2);
