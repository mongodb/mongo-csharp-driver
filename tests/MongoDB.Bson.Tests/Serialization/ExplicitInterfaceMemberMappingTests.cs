...
{
    // Regression test for CSHARP-637.
    public class ExplicitInterfaceMemberMappingTests
    {
        ...
        public void TestMapExplicitGenericMember()
        {
            ...
            Assert.Equal("MongoDB.Bson.Tests.Serialization.ExplicitInterfaceMemberMappingTests.IMyInterface.SomeField2", memberMap.MemberName);
        }
    }
}
