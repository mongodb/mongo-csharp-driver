...
{
    // Regression test for CSHARP-310.
    public class DefaultValueMemberMapConventionTests
    {
        private class C
        {
            public int Id;
        ...
        private static void InitializeSerialization()
        {
            ...
            ConventionRegistry.Register("CSharp310", conventions, type => type.FullName.StartsWith("MongoDB.Bson.Tests.Serialization.Conventions.DefaultValueMemberMapConventionTests", StringComparison.Ordinal));
        }
